...
public interface ReportsFacadeRemote {
    ...
    public boolean makeDcwSnapshotNative(java.util.LinkedList<org.inbio.ara.util.QueryNode> qnlist, java.util.LinkedList<java.lang.String> elist, String dbSchema);
    ...
    public boolean exportToPlic(java.io.File f, String dbSchema, String dataSource);

    public boolean makePlicSnapshotNative(java.util.LinkedList<org.inbio.ara.util.QueryNode> qnlist, java.util.LinkedList<java.lang.String> elist, String dbSchema);
