 ...
 * @author esmata
 */
public class GeographicCatalogueDTO extends GenericDTO{

    private Long geographicCatalogueId;
    private String name;
    private String description;

    public GeographicCatalogueDTO(){}

    /**
     * @return the geographicCatalogueId
     */
    ...
    /**
     * @param geographicCatalogueId the geographicCatalogueId to set
     */
