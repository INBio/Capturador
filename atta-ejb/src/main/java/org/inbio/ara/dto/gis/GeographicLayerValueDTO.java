...
public class GeographicLayerValueDTO implements Serializable {
     ...
     * @param ancestorName
     */
    public GeographicLayerValueDTO(Long geographicLayerKey, 
            Long geographicLayerValueKey, String name,
            Long ancestorGeographicLayerValueKey, String ancestorName) {
