 ...
 * @author esmata
 */
public class GeographicEntityDTO extends GenericDTO{

    private Long geographicEntityId;
    private String name;
    private String description;

    public GeographicEntityDTO(){}

    /**
     * @return the geographicEntityId
     */
    ...
    /**
     * @param geographicEntityId the geographicEntityId to set
     */
