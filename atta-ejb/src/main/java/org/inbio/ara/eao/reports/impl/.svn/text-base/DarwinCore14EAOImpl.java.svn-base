        ...
        String insertString = " insert into ara.DARWIN_CORE_1_4" +
                              " ( GlobalUniqueIdentifier," +
                               ...
                               " from ara.specimen s left outer join ara.identification i on (s.specimen_id = i.specimen_id)" +
                                  ...
                                  " left outer join ara.georeferenced_site gsit on (gsit.site_id = sit.site_id and gsit.geographic_layer_id = 1)" +
                                  " left outer join ara.country coun on (coun.country_id = gsit.geographic_site_id and gsit.geographic_layer_id = 1)" +
                                  " left outer join ara.georeferenced_site gsitp on (gsitp.site_id = sit.site_id and gsitp.geographic_layer_id = 2)" +
                                  " left outer join ara.province prov on (prov.province_id = gsitp.geographic_site_id and gsitp.geographic_layer_id = 2)" +
