                                ...
                                <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; position: relative" width="850">
                                    ...
                                    <webuijsf:panelLayout id="PanelDetails" style="height: 164px; position: relative; width: 840px; -rave-layout: grid" styleClass="My_subpanel_blue">
                                        <webuijsf:label id="lbDescription" requiredIndicator="true"
                                            style="height: 24px; left: 24px; top: 24px; position: absolute; width: 164px" text="#{resources.description}"/>
                                        <webuijsf:label for="ddType" id="lbType" style="height: 24px; left: 24px; top: 77px; position: absolute; width: 164px" text="#{resources.type}"/>
                                        ...
                                        <webuijsf:label for="ddDetermination" id="lbDetermination"
                                            style="height: 24px; left: 24px; top: 125px; position: absolute; width: 164px" text="#{resources.determination_method}"/>

                                        <!-- <webuijsf:textArea binding="#{gis$EditSite.txaDescription}" columns="23" id="txaDescription" required="true"
                                            style="position: absolute; left: 192px; top: 24px; width: 168px; height: 24px" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>-->
                                        <webuijsf:textArea binding="#{gis$EditSite.txaDescription}" columns="23" id="txaDescription" required="true"
                                            style="position: absolute; left: 192px; top: 24px; width: 168px; height: 24px"/>
                                        ...
                                        <webuijsf:dropDown binding="#{gis$EditSite.ddType}" id="ddType" items="#{gis$EditSite.typeData.options}" required="true"
                                            ...
                                            style="position: absolute; left: 192px; top: 77px; height: 24px" width="192px"/>
                                        ...
                                        <webuijsf:dropDown binding="#{gis$EditSite.ddDetermination}" id="ddDetermination"
                                            ...
                                            style="position: absolute; left: 192px; top: 125px; height: 24px" width="192px"/>
