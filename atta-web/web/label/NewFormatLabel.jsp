                        ...
                        <webuijsf:form id="form1">
                            ...
                            <h:panelGrid columns="1" id="gridpMain" style="height: 456px; left: 24px; top: 48px; position: absolute" width="888">
                                ...
                                <webuijsf:panelGroup id="grouppBotonera" style="height: 24px; width: 840px">
                                    <h:commandButton action="#{label$NewFormatLabel.btnSaveFormatLabel_action}" id="btnSaveFormatLabel"
                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.btnSave}"/>

                                    <h:commandButton action="#{label$NewFormatLabel.btnCancelFormatLabel_action}" id="btnCancelFormat"
                                ...
                                <webuijsf:panelLayout id="lnTitle" style="height: 68px; position: relative; width: 840px; -rave-layout: grid" styleClass="My_subpanel_blue">
                                    <webuijsf:label id="lbNameFormat" style="left: 0px; top: 24px; position: absolute" text="#{resources.name}"/>
                                    <webuijsf:textField id="txNameFormat" style="left: 72px; top: 24px; position: absolute"/>
