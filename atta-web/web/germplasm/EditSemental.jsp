                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <webuijsf:label binding="#{germplasm$EditSemental.lbTitle}" id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" text="#{resources.edit_semental}"/>
