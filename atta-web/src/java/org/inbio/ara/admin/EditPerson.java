...
public class EditPerson extends AbstractPageBean {
    ...
    public void prerender() {
        //Cargar datos seleccionados de los addremove
        if(this.getPersonSessionBean().isFirstTime()){
            //Mostrar datos actuales en la pantalla
            PersonDTO aux = this.getPersonSessionBean().getCurrentPerson();
            this.getTx1lastName().setText(aux.getLastName());
            this.getTx2lastName().setText(aux.getSecondLastName());            
            this.getTxCity().setText(aux.getCity());
            this.getTxCountry().setText(aux.getCountry());            
            this.getTxEmail().setText(aux.getEmail());
            this.getTxFax().setText(aux.getFax());
            this.getTxInitials().setText(aux.getInitials());
            this.getTxName().setText(aux.getFirstName());
            this.getTxOcupation().setText(aux.getOccupation());
            this.getTxPhoneNumber().setText(aux.getTelephone());
            ...
            this.getPersonSessionBean().setFirstTime(false);
        }
    }
