 ...
 *
 * @version EditInstitution.java
 * @version Created on 28/09/2009, 10:09:03 AM
 * @author esmata
 */

public class EditInstitution extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("EditInstitution Initialization Failure", e);
    ...
    public void prerender() {
        InstitutionDTO aux = this.getInstitutionSessionBean().getCurrentInstitution();
        //Mostrar en la pantalla los datos del current DTO
        txName.setText(aux.getInstitutionName());
        txPhone.setText(aux.getTelephone());
        txFax.setText(aux.getFax());
        txCountry.setText(aux.getCountry());
        txProvince.setText(aux.getStateProvince());
        txCity.setText(aux.getCity());
        txAdreess.setText(aux.getStreetAddress());
        txInstitutionCode.setText(aux.getInstitutionCode());
        txAcronym.setText(aux.getAcronym());
        taURL.setText(aux.getUrl());
    }
    ...
    /**
     * Metodo ejecutado por el boton para editar institucion
     */
    public String btnEditInstitution_action(){
        ...
        institutionCode = (String)this.txInstitutionCode.getText();
        acronym = (String)this.getTxAcronym().getText();
        url = (String)this.getTaURL().getText();

        //Setear el current institutionDTO
        isb.getCurrentInstitution().setInstitutionName(name);
        isb.getCurrentInstitution().setTelephone(phone);
        isb.getCurrentInstitution().setFax(fax);
        isb.getCurrentInstitution().setCountry(country);
        isb.getCurrentInstitution().setStateProvince(province);
        isb.getCurrentInstitution().setCity(city);
        isb.getCurrentInstitution().setStreetAddress(adreess);
        isb.getCurrentInstitution().setInstitutionCode(institutionCode);
        isb.getCurrentInstitution().setAcronym(acronym);
        isb.getCurrentInstitution().setUrl(url);

        try{
            //Update the entity
            this.getInstitutionSessionBean().updateInstitution(isb.getCurrentInstitution());
        }
        catch(Exception e){
        ...
        MessageBean.setSuccessMessageFromBundle("edit_institution_succces", this.getMyLocale());
