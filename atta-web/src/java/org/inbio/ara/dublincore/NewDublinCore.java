 ...
 *
 * @version NewDublinCore.java
 * @version Created on 03/09/2010, 11:32:21 AM
 * @author dasolano
 */

public class NewDublinCore extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("NewDublinCore Initialization Failure", e);
     ...
     * @return
     */
    public String saveDublinCore()
    {
        try
        {
            System.out.println("dto= "+ getdublincore$DublinCoreSessionBean().getDublinCoreDTO());
