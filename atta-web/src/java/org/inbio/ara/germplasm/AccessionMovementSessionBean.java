 ...
 * this class.</p>
 *
 * @version AccessionMovementSessionBean.java
 * @version Created on 11/03/2010, 10:34:19 AM
 * @author dasolano
 */

public class AccessionMovementSessionBean extends AbstractSessionBean implements PaginationCoreInterface{
    ...
    private AccessionMovementDTO accessionMovementDTO = new AccessionMovementDTO();
    ...
    private AccessionMovementDTO queryAccessionMovementDTO = new AccessionMovementDTO();


    private boolean firstTime = true;

    private Long actualWeight = null;


    /**
     * <p>Construct a new session data bean instance.</p>
     */
    public AccessionMovementSessionBean() {
    }
    
    public void resetValues()
    {
        accessionDTO = new AccessionDTO();
        queryAccessionMovementDTO = new AccessionMovementDTO();
        consultaSimple = new String("");
        queryModeSimple = false;
        queryMode = false;
        advancedSearch = false;
        accessionMovementDTO = new AccessionMovementDTO();
        firstTime = true;
        pagination = null;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AccessionMovementSessionBean Initialization Failure", e);
    ...
    public List myReturn(List l) {
        if (l == null) {
            return new ArrayList<AccessionMovementDTO>();
        } else {
            return l;
        }
    }
    ...
    public List getResults(int firstResult, int maxResults) {
        List<AccessionMovementDTO> auxResult = new ArrayList<AccessionMovementDTO>();

        List<AccessionMovementDTO> aListDTO;
    ...
    /**
     * @return the accessionMovementDTO
     */
    public AccessionMovementDTO getAccessionMovementDTO() {
        return accessionMovementDTO;
    }

    /**
     * @param accessionMovementDTO the accessionMovementDTO to set
     */
    public void setAccessionMovementDTO(AccessionMovementDTO accessionMovementDTO) {
        this.accessionMovementDTO = accessionMovementDTO;
    }
    ...
    /**
     * @return the queryAccessionMovementDTO
     */
    public AccessionMovementDTO getQueryAccessionMovementDTO() {
        return queryAccessionMovementDTO;
    }

    /**
     * @param queryAccessionMovementDTO the queryAccessionMovementDTO to set
     */
    public void setQueryAccessionMovementDTO(AccessionMovementDTO queryAccessionMovementDTO) {
        this.queryAccessionMovementDTO = queryAccessionMovementDTO;
    }
     ...
     */
    public AccessionDTO getAccessionDTO() {
        return accessionDTO;
    }
