...
public class NewSemenGathering extends AbstractPageBean {
    ...
    public void prerender() {
        ...
        consistency.setOptions(getSelectionListDropDownData(SelectionListEntity.SEMEN_CONSISTENCY.getId()));
    }
    ...
    public String saveSemenGathering()
    {
        try
        {
            ...
            {
                //asigna el valor
                semenGatheringDTO.setCurrentStrawQuantity(semenGatheringDTO.getStrawQuantity());
