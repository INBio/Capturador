                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <h:outputLabel id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" value="#{resources.newProject}"/>
                                <h:panelGrid columns="1" id="gridpMain" style="left: 24px; position: relative" width="650">
                                    ...
                                    <webuijsf:panelGroup id="grouppBotonera" style="height: 24px; width: 650px">
                                        <h:commandButton action="#{admin$NewProject.btnSaveProject_action}" id="btnSavePerson" style="height: 24px; width: 175px"
                                            ...
                                            <webuijsf:panelLayout id="lpPersonal" style="height: 180px; position: relative; width: 100%; -rave-layout: grid" styleClass="My_subpanel_blue">
                                                ...
                                                <webuijsf:textArea binding="#{admin$NewProject.txDescription}" columns="24" id="tx1lastName" required="true"
                                                ...
                                                <webuijsf:textField binding="#{admin$NewProject.txProjectManager}" columns="25" id="tx2lastName" required="true"
                                                ...
                                                <webuijsf:calendar binding="#{admin$NewProject.initial_date}" columns="25" dateFormatPattern="yyyy-MM-dd"
                                            id="calInitialDate" style="height: 24px; left: 190px; top: 109px; position: absolute; width: 192px"/>
                                              
                                                <webuijsf:calendar binding="#{admin$NewProject.final_date}" columns="25" dateFormatPattern="yyyy-MM-dd"
