                            ...
                            <webuijsf:form id="form1">
                                ...
                                <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; position: relative" width="850">
                                    ...
                                    <h:panelGrid columns="1" id="grouppBotoneraEditTaxonomy" style="height: 24px" width="540">
                                        <h:commandButton action="#{taxonomy$EditTaxonomy2.btnSaveTaxon_action}" id="btnSaveTaxon"
                                    ...
                                    <webuijsf:tabSet id="tabSet1" lite="true" selected="#{taxonomy$TaxonSessionBean.taxonTabSelected}" styleClass="My_panel_blue">
                                        ...
                                        <webuijsf:tab id="tabEditTaxonomy" style="text-align:center;padding:5px" text="#{resources.dataTaxon}">
                                            ...
                                            -->
                                                <h:panelGrid binding="#{taxonomy$EditTaxonomy2.taxonomy}" columns="1" id="indicator">
                                                    ...
                                                    <h:panelGrid columns="2" id="nomenclatural"
                                                        ...
                                                        <webuijsf:textField columns="25" id="txTaxonName" required="true" text="#{taxonomy$TaxonSessionBean.currentTaxon.currentName}"/>
                                                        ...
                                                        <webuijsf:textField autoComplete="true"
                                                            autoCompleteExpression="#{taxonomy$TaxonAutoCompleteBean.getOptions}" columns="25"
                                                            id="tfAutocomplete" style="z-order: 1;" text="#{taxonomy$TaxonAutoCompleteBean.text}"/>
                                                    ...
                                                    <h:panelGrid title="#{resources.external_information}" binding="#{taxonomy$EditTaxonomy2.externalData}" columns="1" id="externalData" style="position: relative; width: 400px; -rave-layout: grid" styleClass="My_subpanel_blue">
                                                        <webuijsf:label  id="lbExternalData" text="#{resources.external_information}"/>
                                                        <h:outputLink onclick="#{taxonomy$EditTaxonomy2.urlGBIF}" value="#">
                                                            <h:outputText value="#{resources.gbif}" />
                                                        </h:outputLink>
                                                        <h:outputLink onclick="#{taxonomy$EditTaxonomy2.urlEOL}" value="#">
                                                            <h:outputText value="#{resources.eol}" />
                                                        </h:outputLink>
                                                        <h:outputLink onclick="#{taxonomy$EditTaxonomy2.urlWikispecies}" value="#">
                                                            <h:outputText value="#{resources.wikispecies}" />
                                                        </h:outputLink>
                                                    </h:panelGrid>
                                                </h:panelGrid>
                                        ...
                                        <webuijsf:tab id="tabTaxonAuthor" text="#{resources.title_author}">
                                            <h:panelGrid columns="1" id="panelTaxonAuthor">
                                                <h:panelGrid columns="1" id="panelAuthorLabel" style="display: block; margin-left: auto; margin-right: auto">
                                                    <webuijsf:label id="lbAuthors" style=" display: block;  text-align: center;" text="#{taxonomy$TaxonSessionBean.authors}"/>
                                                </h:panelGrid>
                                                <h:panelGrid columns="2" id="panelAuthorType">
                                                    <webuijsf:label for="ddAuthorType" id="lbAuthorType" text="#{resources.author_type}"/>
                                                    <webuijsf:dropDown actionExpression="#{taxonomy$EditTaxonomy2.setAuthorList}"
                                                        binding="#{taxonomy$EditTaxonomy2.ddAuthorType}" id="ddAuthorType"
                                                        items="#{taxonomy$TaxonSessionBean.authorType}"
                                                        selected="#{taxonomy$TaxonSessionBean.authorTypeSelected}" submitForm="true"/>
                                                </h:panelGrid>
                                                <h:panelGrid columns="3" id="panelAuthorsList">
                                                    ...
                                                    <h:panelGrid columns="1" id="panelAuthorsActions">
                                                        <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAddAuthor_action}" id="btnAddAuthor"
                                                            style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.add}"/>
                                                        <h:commandButton action="#{taxonomy$EditTaxonomy2.btnEditAuthor_action}" id="btnEditAuthor"
                                                            style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.edit}"/>
                                                        <h:commandButton action="#{taxonomy$EditTaxonomy2.btnRemoveAuthor_action}" id="btnRemoveAuthor"
                                                            style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.remove}"/>
                                                    </h:panelGrid>
                                                    <h:panelGrid columns="1" id="tableAuthorsSelected" styleClass="My_table">
                                                        ...
                                                        <h:dataTable binding="#{taxonomy$EditTaxonomy2.dataTableAuthors}" cellspacing="0"
                                                            columnClasses="list-columns" headerClass="list-header" id="dataTableAuthors"
                                                            rowClasses="list-row-even,list-row-odd" rows="#{taxonomy$TaxonSessionBean.authorListSize}"
                                                ...
                                                <h:panelGrid columns="2" id="panelAuthorsAction"
                                                    rendered="#{taxonomy$TaxonSessionBean.visiblePanelAuthorAction}" styleClass="My_subpanel_blue">
                                                    <webuijsf:label for="txTaxonAuthorSequence" id="lbTaxonAuthorSequence" text="#{resources.taxon_author_sequence}"/>
                                                    <webuijsf:textField columns="25" id="txTaxonAuthorSequence" required="true" text="#{taxonomy$TaxonSessionBean.taxonAuthorSequence}"/>
                                                    <webuijsf:label for="txTaxonAuthorName" id="lbTaxonAuthorName" text="#{resources.taxon_author}"/>
                                                    <webuijsf:textField columns="25" id="txTaxonAuthorName" readOnly="true" text="#{taxonomy$TaxonSessionBean.taxonAuthorName}"/>
                                                    ...
                                                    <webuijsf:dropDown binding="#{taxonomy$EditTaxonomy2.ddConnector}" id="ddConnector"
                                                        items="#{taxonomy$TaxonSessionBean.connectors}" selected="#{taxonomy$TaxonSessionBean.connectorSelected}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAceptAuthor_action}" id="btnAceptAuthor"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.acept}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnCancelAuthor_action}" id="btnCancelAuthor"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.cancel}"/>
                                                </h:panelGrid>
                                            </h:panelGrid>
                                        </webuijsf:tab>
                                        ...
                                        <webuijsf:tab id="tabTaxonCountry" text="#{resources.title_country}">
                                            <h:panelGrid columns="1" id="panelTaxonCountry">
                                                <h:panelGrid columns="1" id="panelCountryLabel" style="display: block; margin-left: auto; margin-right: auto">
                                                    <webuijsf:label id="lbCountry" style=" display: block;  text-align: center;" text="#{resources.title_country}"/>
                                                </h:panelGrid>
                                                <h:panelGrid columns="3" id="panelCountryList">
                                                    <webuijsf:listbox id="countriesList" items="#{taxonomy$EditTaxonomy2.countries}" selected="#{taxonomy$TaxonSessionBean.countrySelected}"/>
                                                    <h:panelGrid columns="1" id="panelCountriesActions">
                                                        <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAddCountry_action}" id="btnAddCountry"
                                                            style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.add}"/>
                                                        <h:commandButton action="#{taxonomy$EditTaxonomy2.btnEditCountry_action}" id="btnEditCountry"
                                                            style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.edit}"/>
                                                        <h:commandButton action="#{taxonomy$EditTaxonomy2.btnRemoveCountry_action}" id="btnRemoveCountry"
                                                            style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.remove}"/>
                                                    </h:panelGrid>
                                                    <h:panelGrid columns="1" id="tableCountriesSelected" styleClass="My_table">
                                                        <h:dataTable binding="#{taxonomy$EditTaxonomy2.dataTableCountries}" cellspacing="0"
                                                            columnClasses="list-columns" headerClass="list-header" id="dataTableCountries"
                                                            rowClasses="list-row-even,list-row-odd" rows="#{taxonomy$TaxonSessionBean.countryListSize}"
                                                            style="border-top: solid rgb(214, 218, 221) 2px; border-bottom: solid rgb(214, 218, 221) 2px; border-left: solid rgb(214, 218, 221) 2px; "
                                                ...
                                                <h:panelGrid columns="2" id="panelCountriesAction"
                                                    rendered="#{taxonomy$TaxonSessionBean.visiblePanelCountryAction}" styleClass="My_subpanel_blue">
                                                    <webuijsf:label for="txTaxonCountryName" id="lbTaxonCountryName" text="#{resources.country}"/>
                                                    <webuijsf:textField columns="25" id="txTaxonCountryName" readOnly="true" text="#{taxonomy$TaxonSessionBean.taxonCountryName}"/>
                                                    <webuijsf:label for="txaTaxonCountryDescription" id="lbTaxonCountryDescription" text="#{resources.description}"/>
                                                    <webuijsf:textArea binding="#{taxonomy$NewTaxonomy.txaCountryDescription}" columns="40"
                                                        id="txaTaxonCountryDescription" style="height: 60px; width: 172px"
                                                        text="#{taxonomy$TaxonSessionBean.countryDescription}" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAceptCountry_action}" id="btnAceptCountry"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.acept}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnCancelCountry_action}" id="btnCancelCountry"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.cancel}"/>
                                                </h:panelGrid>
                                            </h:panelGrid>
                                        </webuijsf:tab>
                                            ...
                                            <h:panelGrid cellspacing="1" columns="1" id="panelTaxonSynonyms" style="width:100%" styleClass="My_panel_sites">
                                                <h:panelGrid columns="1" id="panelSynonyms" styleClass="My_table">
                                                    ...
                                                    <h:panelGrid columns="1" id="gridQuantitySynonyms" styleClass="My_table_top" style="width:100%;">
                                                        <h:outputLabel id="labelQuantitySynonyms" value="#{taxonomy$EditTaxonomy2.quantityTotal}"/>
                                                    </h:panelGrid>
                                                    -->
                                                        <webuijsf:panelGroup id="panelSynonymButtons" separator=" " style="margin-left:70px;">
                                                            <!-- Botones de acciones -->
                                                            <h:commandButton action="#{taxonomy$EditTaxonomy2.btn_newSynonym_action}" id="btn_new"
                                                                style="margin: 2px;height: 22px" styleClass="My_Button_table" value="#{resources.new}"/>
                                                            <h:commandButton action="#{taxonomy$EditTaxonomy2.btn_editSynonym_action}"
                                                                style="margin: 2px;height: 22px" styleClass="My_Button_table" value="#{resources.btnEdit}"/>
                                                            <h:commandButton action="#{taxonomy$EditTaxonomy2.btn_deleteSynonym_action}"
                                                                style="margin: 2px;height: 22px" styleClass="My_Button_table" value="#{resources.btnDelete}"/>
                                                        </webuijsf:panelGroup>
                                                    </webuijsf:panelGroup>
                                                    <h:dataTable binding="#{taxonomy$EditTaxonomy2.dataTableSynonyms}" cellspacing="0"
                                                        columnClasses="list-columns" headerClass="list-header" id="dataTableSynonyms"
                                                        rowClasses="list-row-even,list-row-odd" rows="#{taxonomy$TaxonSessionBean.synonymListSize}"
                                                        style="border-top: solid rgb(214, 218, 221) 2px; border-bottom: solid rgb(214, 218, 221) 2px; border-left: solid rgb(214, 218, 221) 2px; "
                                                ...
                                                <h:panelGrid columns="2" id="panelSynonymsAction"
                                                    rendered="#{taxonomy$TaxonSessionBean.visiblePanelSynonymAction}" styleClass="My_subpanel_blue">
                                                    <webuijsf:label for="tfAutocomplete" id="lbTaxonSynonym" text="#{resources.synonyms}"/>
                                                    <webuijsf:textField autoComplete="true"
                                                        autoCompleteExpression="#{taxonomy$SynonymAutoCompleteBean.getOptions}" columns="25" id="tfAutocomplete"
                                                        style="z-order: 1;" text="#{taxonomy$SynonymAutoCompleteBean.text}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAceptSynonym_action}" id="btnAceptSynonym"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.acept}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnCancelSynonym_action}" id="btnCancelSynonym"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.cancel}"/>
                                                </h:panelGrid>
                                            </h:panelGrid>
                                        </webuijsf:tab>
                                        ...
                                        <webuijsf:tab id="tabTaxonIndicatorReferences" rendered="true" text="#{resources.relations_taxon_indicator}" visible="#{taxonomy$TaxonSessionBean.ableTabTaxonIndicator}">
                                            <h:panelGrid columns="3" id="taxonIndicator">
                                                ...
                                                <h:panelGrid columns="1" id="panelAddRemoveAction">
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAddTaxonIndicator_action}" id="btnAddElement"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.add}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnRemoveTaxonIndicator_action}" id="btnRemoveElement"
                                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.remove}"/>
                                                </h:panelGrid>
                                            ...
                                            <h:panelGrid columns="1" id="gridTaxonIndicatorCountries" style="height: 24px" width="580">
                                                <h:panelGrid columns="2" id="gridCountries" style="height: 24px">
                                                    <webuijsf:panelGroup id="groupAttributes" style="height: 24px">
                                                        ...
                                                        <webuijsf:dropDown actionExpression="#{taxonomy$EditTaxonomy2.updateRightList}"
                                                            binding="#{taxonomy$EditTaxonomy2.ddIndicators}" id="ddIndicators"
                                                            items="#{taxonomy$TaxonSessionBean.indicatorRelations}"
                                                            selected="#{taxonomy$TaxonSessionBean.ddIndicatorSelected}" submitForm="true"/>
                                                    </webuijsf:panelGroup>
                                            ...
                                            <h:panelGrid columns="1" id="gridTaxonIndicatorComponentPart" style="height: 24px" width="580">
                                                <h:panelGrid columns="2" id="gridComponentPart" style="height: 24px">
                                                    <webuijsf:panelGroup id="groupAttributesCP" style="height: 24px">
                                                        ...
                                                        <webuijsf:dropDown actionExpression="#{taxonomy$EditTaxonomy2.updateRightComponentPartList}"
                                                            binding="#{taxonomy$EditTaxonomy2.ddIndicatorsComponentPart}" id="ddIndicatorsCP"
                                                            items="#{taxonomy$TaxonSessionBean.indicatorRelationsAP}"
                                                            selected="#{taxonomy$TaxonSessionBean.ddIndicatorCPSelected}" submitForm="true"/>
                                                    </webuijsf:panelGroup>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAssociateComponentPart_action}"
                                                        id="btnAssociateComponentPart" style="width: 160px" styleClass="My_Button" value="#{resources.button_associate}"/>
                                                </h:panelGrid>
                                                <!-- AddRemove Component -->
                                                    ...
                                                    <h:panelGrid cellspacing="1" columns="3">
                                                        ...
                                                        <h:panelGrid cellspacing="1" columns="1">
                                                            ...
                                                            <h:commandButton action="#{taxonomy$TaxonSessionBean.arComponentPart.addSelectedOptions}"
                                                                id="btnAddCPOptions" style="margin: 2px;height: 22px" styleClass="My_Button_add"/>
                                                            <!-- boton Remover -->
                                                            <h:commandButton action="#{taxonomy$TaxonSessionBean.arComponentPart.removeSelectedOptions}"
                                                                id="btnRemoveCPOptions" style="margin: 2px;height: 22px" styleClass="My_Button_remove"/>
                                                        </h:panelGrid>
                                                        <!-- Selected List -->
                                                        <h:panelGrid cellspacing="1" columns="1">
                                        ...
                                        <webuijsf:tab id="tabBibliographicReferences" text="#{resources.bibliographicReferences}" visible="#{taxonomy$TaxonSessionBean.ableTabTaxonIndicatorDublinCore}">
                                            <h:panelGrid binding="#{taxonomy$EditTaxonomy2.gridDublinCore}">
                                                ...
                                                <h:panelGrid columns="2" id="gridIndicatorDublinCore" style="height: 24px">
                                                    <webuijsf:panelGroup id="groupAttributesDublinCore" style="height: 24px">
                                                        ...
                                                        <webuijsf:dropDown actionExpression="#{taxonomy$EditTaxonomy2.updateIndicatorDCSelected}"
                                                            binding="#{taxonomy$EditTaxonomy2.ddIndicatorsDublinCore}" id="ddIndicatorsDublinCore"
                                                            items="#{taxonomy$TaxonSessionBean.indicatorRelations}"
                                                            selected="#{taxonomy$TaxonSessionBean.ddIndicatorDCSelected}" submitForm="true"/>
                                                    </webuijsf:panelGroup>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAssociateDublinCore_action}"
                                                        id="btnAssociateDublinCore" style="width: 160px" styleClass="My_Button" value="#{resources.button_associate}"/>
                                                </h:panelGrid>
                                                ...
                                                <h:panelGrid columns="3" id="gridpSearch" style="height: 24px" width="719">
                                                    ...
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnSimpleSearch_action}"
                                                        binding="#{taxonomy$EditTaxonomy2.btnSearch}" id="btnDublinCoreSearch"
                                                        style="height: 25px; width: 160px" styleClass="My_Button" value="#{resources.search}"/>
                                                    <h:commandButton action="#{taxonomy$EditTaxonomy2.btnAdvSearch_action}"
                                                        binding="#{taxonomy$EditTaxonomy2.btnAdvSearch}" id="btnAdvDublinCoreSearch"
                                                ...
                                                <h:panelGrid binding="#{taxonomy$EditTaxonomy2.gridpAdvancedSearch}" columns="1" id="gridpAdvancedSearch"
                                            ...
                                            <h:panelGrid cellspacing="1" columns="1" id="gridpTableMain" style="height: 24px" styleClass="My_table" width="840">
                                                ...
                                                <h:dataTable binding="#{taxonomy$EditTaxonomy2.dataTableDublinCore}" cellspacing="0"
                                                    columnClasses="list-columns" headerClass="list-header" id="dataTablegathering"
                                                    rowClasses="list-row-even,list-row-odd" rows="#{taxonomy$TaxonSessionBean.pagination.resultsPerPage}"
                                                    style="border-top: solid rgb(214, 218, 221) 2px; border-bottom: solid rgb(214, 218, 221) 2px; border-left: solid rgb(214, 218, 221) 2px; "
