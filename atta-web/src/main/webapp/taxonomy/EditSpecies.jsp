    ...
    <f:view>
        <webuijsf:page id="page1">
            <webuijsf:html id="html1">
                <webuijsf:head binding="#{Header_Login.head1}" id="head1" title="Especies">
                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form binding="#{taxonomy$EditSpecies.form1}" id="form1">
                                <h:outputLabel id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" value="#{resources.edit_record}"/>
                                <h:panelGrid columns="1" id="gridpMain" style="left: 48px; position: relative" width="850">
                                    ...
                                    <webuijsf:tabSet id="tabSetSpeciesRecord" lite="true" selected="tabDescription" style="width: 840px" styleClass="My_panel_blue">
