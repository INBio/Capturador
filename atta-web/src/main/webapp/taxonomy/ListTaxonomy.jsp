                ...
                <webuijsf:body id="body1" onLoad="initTaxonomy()" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <h:outputLabel id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" value="#{resources.taxon}"/>
                            <h:panelGrid columns="2" id="gridpSearch" style="height: 24px; left: 24px; position: relative" width="350">
                                <webuijsf:textField
                                    autoComplete="true"
                                ...
                                <h:commandButton action="#{taxonomy$ListTaxonomy.btnSearch_action}" id="btnSearch"
                                                     style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.search}"/>
                            </h:panelGrid>
