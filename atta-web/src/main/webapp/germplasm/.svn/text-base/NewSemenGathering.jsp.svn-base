                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <h:outputLabel id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" value="#{resources.new_semen_gathering}"/>
                                    ...
                                    <h:panelGrid id="content" columns="2" style="position:relative; width:840px">
                                        ...
                                        <h:panelGrid id="content2" columns="2" style="position:relative;">
                                            ...
                                            <webuijsf:dropDown id="dropdownSolvent"  width="190px"
                                                               items="#{germplasm$NewSemenGathering.solvent.options}"
