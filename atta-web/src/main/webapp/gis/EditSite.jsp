                            ...
                            <webuijsf:form id="form1">
                                ...
                                <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; position: relative" width="850">
                                    ...
                                    <webuijsf:tabSet id="tabSetSites" lite="true" selected="tabCoordinates" style="height: 440px; width: 840px" styleClass="My_tab_border">
                                        ...
                                        <webuijsf:tab id="tabGeoreferenceSites" text="#{resources.georeferencing}" actionExpression="#{gis$EditSite.onChangeTab_action}">
                                            <webuijsf:panelLayout id="lpPGeoreferenceSites" style="height: 263px; position: relative; width: 100%; -rave-layout: grid">
                                                ...
                                                <h:dataTable binding="#{gis$EditSite.dataTableGeoreferencedSites}" cellspacing="0" columnClasses="list-columns"
