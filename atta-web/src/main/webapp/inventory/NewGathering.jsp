                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <h:outputLabel id="lbNewGatheringTitle" style="height: 24px; left: 24px; position: relative; width: 850px"
                                    styleClass="Page_title" value="#{resources.title_gathering_observation_new}"/>
                                <h:panelGrid columns="1" id="gridpNewGatheringMain" style="height: 480px; left: 24px; position: relative" width="850">
                                    ...
                                    <webuijsf:panelLayout id="layoutpNewGathDetails" style="height: 212px; position: relative; width: 758px; -rave-layout: grid" styleClass="My_panel_blue">
                                        <webuijsf:label for="tfSiteAutocomplete" id="lblocality" requiredIndicator="true"
                                            style="height: 20px; left: 24px; top: 24px; position: absolute; width: 116px" text="#{resources.locality}"/>
                                        <webuijsf:label for="tfPersonAutocomplete" id="lbResponsible" requiredIndicator="true"
                                            style="height: 24px; left: 398px; top: 24px; position: absolute; width: 118px" text="#{resources.person_in_charge}"/>
                                        <webuijsf:label for="calInitialDate" id="lbInitialDate" requiredIndicator="true"
                                            style="height: 24px; left: 24px; top: 48px; position: absolute; width: 116px" text="#{resources.initial_date}"/>
                                        <webuijsf:label for="calFinalDate" id="lbFinalDate" requiredIndicator="true"
                                            style="height: 24px; left: 398px; top: 48px; position: absolute; width: 118px" text="#{resources.final_date}"/>
                                        <!--
                                        <webuijsf:dropDown binding="#{inventory$NewGathering.ddLocalities}" id="ddLocality"
                                            ...
                                            style="height: 24px; left: 155px; top: 24px; position: absolute" width="192px"/>
                                        -->
                                        <webuijsf:textField
                                            autoComplete="true"
                                            autoCompleteExpression = "#{gis$SiteAutoCompleteSessionBean.getOptions}"
                                            text="#{gis$SiteAutoCompleteSessionBean.text}"
                                            style="height: 24px; left: 155px; top: 24px; position: absolute"
                                            id = "tfSiteAutocomplete"
                                            columns="25"
                                            required="true"
                                         >
                                        </webuijsf:textField>
                                        ...
                                        <webuijsf:textField
                                            autoComplete="true"
                                            autoCompleteExpression = "#{inventory$PersonAutoCompleteBean.getOptions}"
                                            text="#{inventory$PersonAutoCompleteBean.text}"
                                            style="height: 24px; left: 528px; top: 24px; position: absolute"
                                            id = "tfPersonAutocomplete"
                                            columns="25"
                                            required="true"
                                         >
                                        </webuijsf:textField>
                                        ...
                                        <webuijsf:dropDown binding="#{inventory$NewGathering.ddResponsible}" id="ddResponsible"
                                            ...
                                            style="height: 24px; left: 528px; top: 24px; position: absolute" width="192px"/>
                                        -->
                                        <webuijsf:calendar binding="#{inventory$NewGathering.initial_date}" columns="22" dateFormatPattern="yyyy-MM-dd"
                                            id="calInitialDate" required="true" style="height: 24px; left: 145px; top: 48px; position: absolute; width: 192px"/>
                                        <webuijsf:calendar binding="#{inventory$NewGathering.final_date}" columns="22" dateFormatPattern="yyyy-MM-dd"
                                            id="calFinalDate" required="true" style="height: 24px; left: 518px; top: 48px; position: absolute; width: 192px"/>
                                        <webuijsf:label for="txGradient" id="lbGradient"
                                            style="height: 24px; left: 24px; top: 72px; position: absolute; width: 116px" text="#{resources.gradient}"/>
                                        <webuijsf:label for="ddExposicion" id="lbExposicion"
                                            style="height: 24px; left: 398px; top: 72px; position: absolute; width: 118px" text="#{resources.exposition}"/>
                                        <webuijsf:dropDown binding="#{inventory$NewGathering.ddExposition}" id="ddExposicion"
                                            ...
                                            style="height: 24px; left: 528px; top: 72px; position: absolute" width="192px"/>
                                        <webuijsf:textField binding="#{inventory$NewGathering.txGradient}" columns="25" id="txGradient"
                                            style="height: 24px; left: 155px; top: 72px; position: absolute; width: 180px" validatorExpression="#{util$ValidatorBean.longNumberFormatValidator}"/>
                                        <webuijsf:label id="lbElevation" style="height: 24px; left: 24px; top: 96px; position: absolute; width: 116px" text="#{resources.elevation}"/>
                                        <webuijsf:label id="lbDepth" style="height: 24px; left: 398px; top: 96px; position: absolute; width: 118px" text="#{resources.depth}"/>
                                        <webuijsf:textField binding="#{inventory$NewGathering.txElevationMin}" columns="10" id="txElevationMin"
                                            style="height: 24px; left: 155px; top: 96px; position: absolute; width: 80px" validatorExpression="#{util$ValidatorBean.doubleNumberFormatValidator}"/>
                                        ...
                                        <webuijsf:textField binding="#{inventory$NewGathering.txElevationMax}" columns="10" id="txElevationMax"
                                            style="height: 24px; left: 155px; top: 120px; position: absolute; width: 80px" validatorExpression="#{util$ValidatorBean.doubleNumberFormatValidator}"/>
                                        ...
                                        <webuijsf:textField binding="#{inventory$NewGathering.txDepthMin}" columns="10" id="txDepthMin"
                                            style="height: 24px; left: 528px; top: 96px; position: absolute; width: 80px" validatorExpression="#{util$ValidatorBean.doubleNumberFormatValidator}"/>
                                        <webuijsf:label id="lbDepthMin" style="height: 24px; left: 638px; top: 96px; position: absolute; width: 96px" text="#{resources.minimum}"/>
                                        <webuijsf:textField binding="#{inventory$NewGathering.txDepthMax}" columns="10" id="txDepthMax"
                                            style="height: 24px; left: 528px; top: 120px; position: absolute; width: 80px" validatorExpression="#{util$ValidatorBean.doubleNumberFormatValidator}"/>
                                        <webuijsf:label id="lbDepthMax" style="height: 24px; left: 638px; top: 120px; position: absolute; width: 96px" text="#{resources.maximum}"/>
                                        <webuijsf:label for="txaSurrounding" id="lbSurrounding"
                                            style="height: 24px; left: 24px; top: 144px; position: absolute; width: 116px" text="#{resources.surroundings_description}"/>
                                        <webuijsf:textArea binding="#{inventory$NewGathering.txaSurrounding}" columns="23" id="txaSurrounding"
                                            style="height: 40px; left: 155px; top: 144px; position: absolute; width: 172px" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
                                        <webuijsf:label id="lbSiteDescription" style="height: 24px; left: 398px; top: 144px; position: absolute; width: 118px" text="#{resources.site_description}"/>
                                        <webuijsf:textArea binding="#{inventory$NewGathering.txaSiteDescription}" columns="23" id="txaSiteDescription"
                                            style="height: 40px; left: 528px; top: 144px; position: absolute; width: 172px" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
