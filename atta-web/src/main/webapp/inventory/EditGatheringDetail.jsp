                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <h:outputLabel id="lbDetailEditTitle" style="height: 24px; left: 24px; position: relative; width: 850px"
                                    styleClass="Page_title" value="#{resources.edit_gath_detail}: #{inventory$GatheringDetailSessionBean.currentGathering.gatheringObservationId}"/>
                                <h:panelGrid id="gridpNewDetail" style="height: 24px; left: 24px; position: relative" width="600">
