...
public class SnapshotSessionBean extends AbstractSessionBean {
    ...
    public boolean createDwcSnapshot(String dbSchema){
        return reportsFacade.makeDcwSnapshotNative(queryList, elementList, dbSchema);
    }

    //Method to create the plinian core snapshot with all information
    public boolean createPlicSnapshot(String dbSchema){
        return reportsFacade.makePlicSnapshotNative(queryList, elementList, dbSchema);
    }
