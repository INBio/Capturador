 ...
 * @version Created on 05/11/2009, 11:16:48 AM
 * @author esmata
 */
...
public class StandardSelection extends AbstractPageBean {
   ...
   //En esta variable se setearan los datos del radio button group
    ...
    public void prerender() {
        ...
        Option op1 = new Option(1,BundleHelper.getDefaultBundleValue
                ("standard_plinian",this.getMyLocale()));
        Option op2 = new Option(2,BundleHelper.getDefaultBundleValue
                ("standard_darwin",this.getMyLocale()));
    ...
    public String btnProcced_action() {
        int selectedItem = this.getSnapshotSessionBean().getResultRadioGroup();
        if (selectedItem == 1){
            return "irPlinian";
            //MessageBean.setSuccessMessageFromBundle("not_yet",this.getMyLocale());
            //return null;
        }
