 ...
 *
 * @version PreviewSemenGathering.java
 * @version Created on 07/10/2010, 01:23:53 PM
 * @author dasolano
 */

public class PreviewSemenGathering extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("PreviewSemenGathering Initialization Failure", e);
    ...
    public void prerender() {
        ...
        {
            getLbTitle().setText(BundleHelper.getDefaultBundleValue("detail_informacion", this.getMyLocale()) + ":  " +
