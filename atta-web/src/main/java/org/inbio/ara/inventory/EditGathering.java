...
public class EditGathering extends AbstractPageBean {
    ...
    public void prerender() {
        ...
        this.getPersonAutoCompleteSessionBean().setProfileId(ProfileEntity.GATHERING_RESPONSIBLE_PROFILE.getId());
        ...
        if(this.getinventory$GatheringSessionBean().isFirstTime()){
            ...
            System.out.println("Primera vez de Edit");
            ...
            this.loadAutocomplete(); //load autocomplete
    ...
    {
        System.out.println("Cargando Autocomplete");
        SiteAutoCompleteSessionBean sacs = this.getSiteAutocompleteSessionBean();

        PersonAutoCompleteSessionBean pacs = this.getPersonAutoCompleteSessionBean();

        GatheringSessionBean gsb = this.getinventory$GatheringSessionBean();
        System.out.println(gsb.getCurrentGatheringDTO().getLocalityId());
        //set siteAutoComplete
        String siteDescription = gsb.getSiteDescriptionById(gsb.getCurrentGatheringDTO().getLocalityId());
        sacs.getOptionHash().put(siteDescription, gsb.getCurrentGatheringDTO().getLocalityId());
        sacs.setText(siteDescription);

        String person = gsb.getPersonById(gsb.getCurrentGatheringDTO().getResponsibleId());
        pacs.getOptionHash().put(person, gsb.getCurrentGatheringDTO().getResponsibleId());
        pacs.setText(person);
   ...
   /**
    ...
    public String btnUpdateGathering_action() {
        ...
        if((this.getSiteAutocompleteSessionBean().getIdSelected() != null && this.getSiteAutocompleteSessionBean().getText().length()>=0)||
        (this.getPersonAutoCompleteSessionBean().getIdSelected() != null && this.getPersonAutoCompleteSessionBean().getText().length()>=0))
        {
            GatheringSessionBean gsb = this.getinventory$GatheringSessionBean();
            ...
            gsb.getCurrentGatheringDTO().setLocalityId(this.getSiteAutocompleteSessionBean().getIdSelected());
            gsb.getCurrentGatheringDTO().setResponsibleId(this.getPersonAutoCompleteSessionBean().getIdSelected());
