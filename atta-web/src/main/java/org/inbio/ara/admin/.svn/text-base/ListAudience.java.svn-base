 ...
 *
 * @version ListAudience.java
 * @version Created on 05/10/2009, 10:29:39 AM
 * @author esmata
 */

public class ListAudience extends AbstractPageBean {
    ...
    //Binding de la tabla
    private HtmlDataTable AudiencesTable = new HtmlDataTable();
    ...
    public void init() {
        ...
        try {
            ...
            log("ListAudience Initialization Failure", e);
    ...
    /**
     * @return the AudiencesTable
     */
    public HtmlDataTable getAudiencesTable() {
        return AudiencesTable;
    }

    /**
     * @param AudiencesTable the AudiencesTable to set
     */
    public void setAudiencesTable(HtmlDataTable AudiencesTable) {
        this.AudiencesTable = AudiencesTable;
    }
    ...
    public String getQuantityTotal() {
        quantityTotal = this.getAudienceSessionBean().getQuantityTotal();
    ...
    /**
     * Metodo ejecutado por el boton de crear nuevas audiencias
     * @return
     */
    public String btnAudienceNew(){
