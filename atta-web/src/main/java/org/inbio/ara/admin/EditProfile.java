 ...
 *
 * @version EditProfile.java
 * @version Created on 06/10/2009, 08:37:03 AM
 * @author esmata
 */
...
public class EditProfile extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("EditProfile Initialization Failure", e);
    ...
    public void prerender() {
        ...
        this.getTxName().setText(this.getProfileSessionBean().
                getCurrentProfileDTO().getName());
        this.getTxaDescription().setText(this.getProfileSessionBean().
                getCurrentProfileDTO().getDescription());
    }
    ...
    /**
     * Metodo ejecutado por el boton para editar profile
     * @return
     */
    public String btnUpdateProfile_action() {
        ...
        this.getProfileSessionBean().getCurrentProfileDTO().setName(name);
        this.getProfileSessionBean().getCurrentProfileDTO().setDescription(description);

        //Persistir nuevos datos
        try{
            this.getProfileSessionBean().updateProfile
                    (this.getProfileSessionBean().getCurrentProfileDTO());
        }
        catch(Exception e){
            MessageBean.setErrorMessageFromBundle
                    ("error", this.getMyLocale());
            return null;
        }
        ...
        this.getProfileSessionBean().getPagination().refreshList();

        //Notificar al usuario
        MessageBean.setSuccessMessageFromBundle
                ("edit_profile_succces", this.getMyLocale());
