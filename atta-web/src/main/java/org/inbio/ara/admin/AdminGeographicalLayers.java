 ...
 * @version Created on 16/11/2009, 04:09:01 PM
 * @author esmata
 */
...
public class AdminGeographicalLayers extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("AdminGeographicalLayers Initialization Failure", e);
    ...
    /**
     * Boton de crear nuevo valor
     * @return
     */
    public String btn_newValue_action() {
        this.btnEdit.setDisabled(true);
        this.getadmin$AdminGeographicLayersSessionBean().
                newGeographicLayerValue();
        return null;
    }

    /**
     * Boton de editar valor
     * @return
     */
    public String btn_editValue_action() {
        this.btnNew.setDisabled(true);
        this.getadmin$AdminGeographicLayersSessionBean().
                editGeographicLayerValue();
        return null;
    }

    /**
     * Drop down de capas geograficas
     * @return
     */
    public String onGeographicLayerChange(){
        this.getadmin$AdminGeographicLayersSessionBean().
                onGeographicLayerChange();
        //Habilitar los dos botones
        this.btnEdit.setDisabled(false);
        this.btnNew.setDisabled(false);
        return null;
    }

    public String onGeographicLayerValueChange(){
        this.getadmin$AdminGeographicLayersSessionBean().
                onGeographicLayerValueChange();
        //Habilitar los dos botones
        this.btnEdit.setDisabled(false);
        this.btnNew.setDisabled(false);
        return null;
    ...
    public String onAncestorGeographicLayerValueChange(){
        this.getadmin$AdminGeographicLayersSessionBean().
                onAncestorGeographicLayerValueChange();
        //Habilitar los dos botones
        this.btnEdit.setDisabled(false);
        this.btnNew.setDisabled(false);
        return null;
    ...
    public String saveGeographicLayerValue(){
        boolean result = this.getadmin$AdminGeographicLayersSessionBean().
                saveGeographicLayerValue();
        if(result){
            MessageBean.setSuccessMessageFromBundle("stored", this.getMyLocale());
        }
        else{
            MessageBean.setErrorMessageFromBundle("not_stored", this.getMyLocale());
        }
        //Habilitar los dos botones
        this.btnEdit.setDisabled(false);
        this.btnNew.setDisabled(false);
     ...
     */
    public void setBtnNew(HtmlCommandButton btnNew) {
        this.btnNew = btnNew;
    }
