...
*/
    ...
    //Synonyms
    private boolean visiblePanelSynonymAction = false;
    ...
    /*SYNONYM*/
    private List<SynonymDTO> synonymList = new ArrayList<SynonymDTO>();
    private List<SynonymDTO> synonymDBList = new ArrayList<SynonymDTO>();
    private int synonymListSize = 0;
    private int countSynonymSelected = 0;
    private int positionSynonymSelected = -1;

    /*TAXON COUNTRY*/
    private Long countrySelected;
    private Set<Option> countries =  new HashSet<Option>();
    private boolean newCountryAction = true;
    private TaxonCountryDTO newCountry = null;
    private String taxonCountryName;
    private boolean visiblePanelCountryAction = false;
    private int countTaxonCountrySelected = 0;
    private int positionTaxonCountrySelected = -1;
    private List<TaxonCountryDTO> countryList = new ArrayList<TaxonCountryDTO>();
    private List<TaxonCountryDTO> countryDBList = new ArrayList<TaxonCountryDTO>();
    private String countryDescription;
    private int countryListSize = 0;
    private Map<Long, Option> allCountriesDBMap = new HashMap<Long, Option>();


    private boolean newSynonymAction = true;
    private SynonymDTO newSynonym = null;
...
//            allTaxonAuthors.add(new Option(personAuthor.getPersonId(),personAuthor.getName()));
    ...
    public int getPosSynonymSelected()
    {
         //System.out.println("-- Entro a Contar");
         int result = -1;

         for(int pos= 0;pos < synonymList.size(); pos++)
         {
             if(synonymList.get(pos).isSelected())
             {

                 result = pos;
                 countSynonymSelected++;
             }
         }
     ...
     */
    public List<SynonymDTO> getSynonymList() {
        return synonymList;
    }

    /**
     * @param synonymList the synonymList to set
     */
    public void setSynonymList(List<SynonymDTO> synonymList) {
        this.synonymList = synonymList;
    }

    /**
     * @return the synonymListSize
     */
    public int getSynonymListSize() {
        //return synonymListSize;
        return synonymList.size();
    }

    /**
     * @param synonymListSize the synonymListSize to set
     */
    public void setSynonymListSize(int synonymListSize) {
        this.synonymListSize = synonymListSize;
    }


   public List<SynonymDTO> getSynonymsByTaxonId(Long taxonId)
   {
      return getTaxonomyFacade().getSynonymsByTaxonId(taxonId);
   }


    public SynonymDTO getSynonymSelected()
     {
         SynonymDTO result = null;
         for(SynonymDTO synonym: synonymList)
         {
     ...
     public SynonymDTO removeSynonymSelected()
     {
         SynonymDTO result = null;
         ...
         synonymList.remove(result);
         return result;

     }


     public void saveSynonyms(Long taxonId, List<Long> synonyms)
     {
         this.taxonomyFacade.saveSynonyms(taxonId, synonyms, this.getAraSessionBean().getGlobalUserName());
     }


     public void deleteSynonyms(Long taxonId, List<Long> synonyms)
     {
         this.taxonomyFacade.deleteSynonyms(taxonId, synonyms, this.getAraSessionBean().getGlobalUserName());
     }
     ...
     */
    public void setCountries(Set<Option> countries) {
        this.countries = countries;
    }

    /**
     * @return the newCountryAction
     */
    public boolean isNewCountryAction() {
        return newCountryAction;
    }

    /**
     * @param newCountryAction the newCountryAction to set
     */
    public void setNewCountryAction(boolean newCountryAction) {
     ...
     */
    public TaxonCountryDTO getNewCountry() {
        return newCountry;
    }
     ...
     */
    public void setNewCountry(TaxonCountryDTO newCountry) {
        this.newCountry = newCountry;
    }

    /**
     * @return the taxonCountryName
     */
    public String getTaxonCountryName() {
        return taxonCountryName;
    }

    /**
     * @param taxonCountryName the taxonCountryName to set
     */
    public void setTaxonCountryName(String taxonCountryName) {
        this.taxonCountryName = taxonCountryName;
    }

    /**
     * @return the visiblePanelCountryAction
     */
    public boolean isVisiblePanelCountryAction() {
        return visiblePanelCountryAction;
    }

    /**
     * @param visiblePanelCountryAction the visiblePanelCountryAction to set
     */
    public void setVisiblePanelCountryAction(boolean visiblePanelCountryAction) {
        this.visiblePanelCountryAction = visiblePanelCountryAction;
    }

    /**
     * @return the countTaxonCountrySelected
     */
    public int getCountTaxonCountrySelected() {
        return countTaxonCountrySelected;
    }

    /**
     * @param countTaxonCountrySelected the countTaxonCountrySelected to set
     */
    public void setCountTaxonCountrySelected(int countTaxonCountrySelected) {
        this.countTaxonCountrySelected = countTaxonCountrySelected;
    }

    /**
     * @return the positionTaxonCountrySelected
     */
    public int getPositionTaxonCountrySelected() {
        return positionTaxonCountrySelected;
    }

    /**
     * @param positionTaxonCountrySelected the positionTaxonCountrySelected to set
     */
    public void setPositionTaxonCountrySelected(int positionTaxonCountrySelected) {
        this.positionTaxonCountrySelected = positionTaxonCountrySelected;
    }


     public int getPosTaxonCountrySelected()
     {
         //System.out.println("-- Entro a Contar");
         int result = -1;
         ...
         {
             if(countryList.get(pos).isSelected())
             {

                 result = pos;
                 countTaxonCountrySelected++;
             }
         }
     ...
     public TaxonCountryDTO getTaxonCountrySelected()
     {
         TaxonCountryDTO result = null;
         for(TaxonCountryDTO taxonCountry: countryList)
         {
             if(taxonCountry.isSelected())
             {
                 result = taxonCountry;
                 countTaxonCountrySelected++;
             }
     ...
     public TaxonCountryDTO removeTaxonCountrySelected()
     {
         TaxonCountryDTO result = null;
         ...
         countryList.remove(result);
         return result;

     }


    public void saveTaxonCountryDTOs(Long taxonId, List<TaxonCountryDTO> taxonCountryDTOs, String userName)
    {
        this.getTaxonomyFacade().saveTaxonCountries(taxonId, taxonCountryDTOs, userName);
    }
    ...
    public List<TaxonCountryDTO> getTaxonCountriesByTaxon(Long taxonId)
    {

        return taxonomyFacade.getCountriesByTaxonId(taxonId);
    }


    public void loadAllCountries()
    {
        List<CountryDTO> countryDTOs = this.getAllCountry();

        for(CountryDTO countryDto: countryDTOs)
        {
//            allTaxonAuthors.add(new Option(personAuthor.getPersonId(),personAuthor.getName()));
            allCountriesDBMap.put(countryDto.getCountryId(), new Option(countryDto.getCountryId(),
                                                                             countryDto.getValue()));
    ...
    {
            System.out.println("ENTRO a setCountries");
        
            Map allCountries = new HashMap();
            allCountries.putAll(allCountriesDBMap);

            System.out.println("allCountries = "+allCountries.size());
            
            List<TaxonCountryDTO> tmpTaxonCountries = new ArrayList<TaxonCountryDTO>();
            
            tmpTaxonCountries.addAll(countryList);

            System.out.println("tmpTaxonCountries = "+tmpTaxonCountries.size());
           
            for(int posCountry = 0; posCountry < tmpTaxonCountries.size();posCountry++)
            {                
                Long tmpCountryId = tmpTaxonCountries.get(posCountry).getCountryId();
                System.out.println("tmpCountryId = "+tmpCountryId);
                System.out.println("se encuentra en el map? "+allCountries.containsKey(tmpCountryId));
                if(allCountries.containsKey(tmpCountryId))
                {

                    Option tmpCountry = (Option) allCountries.get(tmpCountryId);
                    tmpTaxonCountries.get(posCountry).setCountryName(tmpCountry.getLabel());
                    
                    allCountries.remove(tmpCountryId);
                }
                else
                {
                    System.out.println("\t\tNo cumple");
            ...
            countryList = tmpTaxonCountries;
            
            //dbAuthorListMap.put(tap[pos].getId(), tmpTaxonAuthors);
            countryDBList =  (List<TaxonCountryDTO>)deepCopy(tmpTaxonCountries);
            countries = new HashSet<Option>(allCountries.values());
            //taxonAuthorsMap.put(tap[pos].getId(), tmpOptions);
    ...
    public void deleteTaxonCountryByTaxonCountryIds(List<TaxonCountryDTO> taxonCountryDtos)
    {
        this.getTaxonomyFacade().deleteTaxonCountryByTaxonCountryIds(taxonCountryDtos);
    }

    public void  updateTaxonCountries(List<TaxonCountryDTO> taxonCountryDtos)
    {
        for(TaxonCountryDTO taxonCountryDTO: taxonCountryDtos)
        {
            taxonCountryDTO.setUserName(this.getAraSessionBean().getGlobalUserName());
            this.getTaxonomyFacade().updateTaxonCountry(taxonCountryDTO);
        }
    }


    public int findTaxonCountry(Long countryId, List<TaxonCountryDTO> dbTaxonCountries)
    {
        int result = -1;
        int size = dbTaxonCountries.size();
        for(int pos = 0; pos < size; pos++)
        {
            if(dbTaxonCountries.get(pos).getCountryId().equals(countryId))
            {
                result = pos;
                break;
            }
     ...
     */
    public List<TaxonCountryDTO> getCountryList() {
        return countryList;
    }
     ...
     */
    public void setCountryList(List<TaxonCountryDTO> countryList) {
    ...
    /**
     * @param countryListSize the countryListSize to set
     */
    public void setCountryListSize(int countryListSize) {
        this.countryListSize = countryListSize;
    }

    /**
     * @return the allCountriesDBMap
     */
    public Map<Long, Option> getAllCountriesDBMap() {
        return allCountriesDBMap;
    }

    /**
     * @param allCountriesDBMap the allCountriesDBMap to set
     */
    public void setAllCountriesDBMap(Map<Long, Option> allCountriesDBMap) {
        this.allCountriesDBMap = allCountriesDBMap;
    }

    /**
     * @return the countryDBList
     */
    public List<TaxonCountryDTO> getCountryDBList() {
        return countryDBList;
    }

    /**
     * @param countryDBList the countryDBList to set
     */
    public void setCountryDBList(List<TaxonCountryDTO> countryDBList) {
        this.countryDBList = countryDBList;
    }

    /**
     * @return the visiblePanelSynonymAction
     */
    public boolean isVisiblePanelSynonymAction() {
        return visiblePanelSynonymAction;
    }

    /**
     * @param visiblePanelSynonymAction the visiblePanelSynonymAction to set
     */
    public void setVisiblePanelSynonymAction(boolean visiblePanelSynonymAction) {
        this.visiblePanelSynonymAction = visiblePanelSynonymAction;
    }

    /**
     * @return the newSynonymAction
     */
    public boolean isNewSynonymAction() {
        return newSynonymAction;
    }

    /**
     * @param newSynonymAction the newSynonymAction to set
     */
    public void setNewSynonymAction(boolean newSynonymAction) {
        this.newSynonymAction = newSynonymAction;
    }

    /**
     * @return the newSynonym
     */
    public SynonymDTO getNewSynonym() {
        return newSynonym;
    }

    /**
     * @param newSynonym the newSynonym to set
     */
    public void setNewSynonym(SynonymDTO newSynonym) {
        this.newSynonym = newSynonym;
    }

    /**
     * @return the countSynonymSelected
     */
    public int getCountSynonymSelected() {
        return countSynonymSelected;
    }

    /**
     * @param countSynonymSelected the countSynonymSelected to set
     */
    public void setCountSynonymSelected(int countSynonymSelected) {
        this.countSynonymSelected = countSynonymSelected;
    }

    /**
     * @return the positionSynonymSelected
     */
    public int getPositionSynonymSelected() {
        return positionSynonymSelected;
    }

    /**
     * @param positionSynonymSelected the positionSynonymSelected to set
     */
    public void setPositionSynonymSelected(int positionSynonymSelected) {
        this.positionSynonymSelected = positionSynonymSelected;
    }

    /**
     * @return the synonymDBList
     */
    public List<SynonymDTO> getSynonymDBList() {
        return synonymDBList;
    }

    /**
     * @param synonymDBList the synonymDBList to set
     */
    public void setSynonymDBList(List<SynonymDTO> synonymDBList) {
    ...
    {
        return  this.taxonomyFacade.getTaxonByCollection(collectionId);
    }

    public String getTaxonPath(Long taxonId, Long initialPath){
        return  this.taxonomyFacade.getTaxonPath(taxonId, initialPath);
    }
