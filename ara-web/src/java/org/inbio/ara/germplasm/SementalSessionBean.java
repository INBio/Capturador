 ...
 * this class.</p>
 *
 * @version SementalSessionBean.java
 * @version Created on 08/04/2010, 10:26:26 AM
 * @author dasolano
 */

public class SementalSessionBean extends AbstractSessionBean implements PaginationCoreInterface{
    ...
    private SementalDTO sementalDTO = new SementalDTO();
    ...
    private SementalDTO querySementalDTO = new SementalDTO();


    private boolean firstTime = true;

    private Long deleteSemental = null;

    /**
     * <p>Construct a new session data bean instance.</p>
     */
    public SementalSessionBean() {
    }

    public void resetValues()
    {
        sementalDTO = new SementalDTO();
        querySementalDTO = new SementalDTO();
    ...
    public void init() {
        ...
        try {
            ...
            log("SementalSessionBean Initialization Failure", e);
    ...
    public List myReturn(List l) {
        if (l == null) {
            return new ArrayList<SementalDTO>();
        } else {
            return l;
        }
    }
    ...
    public List getResults(int firstResult, int maxResults) {
        List<SementalDTO> auxResult = new ArrayList<SementalDTO>();

        List<SementalDTO> aListDTO;
    ...
    /**
     * @return the sementalDTO
     */
    public SementalDTO getSementalDTO() {
        return sementalDTO;
    }

    /**
     * @param sementalDTO the sementalDTO to set
     */
    public void setSementalDTO(SementalDTO sementalDTO) {
        this.sementalDTO = sementalDTO;
    }
    ...
    /**
     * @return the querySementalDTO
     */
    public SementalDTO getQuerySementalDTO() {
        return querySementalDTO;
    }

    /**
     * @param querySementalDTO the querySementalDTO to set
     */
    public void setQuerySementalDTO(SementalDTO querySementalDTO) {
        this.querySementalDTO = querySementalDTO;
    }
    ...
    /**
     * @return the deleteSemental
     */
    public Long getDeleteSemental() {
        return deleteSemental;
    }

    /**
     * @param deleteSemental the deleteSemental to set
     */
    public void setDeleteSemental(Long deleteSemental) {
        this.deleteSemental = deleteSemental;
    }
