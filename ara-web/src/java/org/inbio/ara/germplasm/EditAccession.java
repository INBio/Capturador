 ...
 *
 * @version EditAccession.java
 * @version Created on 09/03/2010, 11:57:23 AM
 * @author dasolano
 */

public class EditAccession extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("EditAccession Initialization Failure", e);
    ...
    public void prerender() {
        ...
        if(getgermplasm$AccessionSessionBean().getEditAccessionDTO() != null)
            getLbTitle().setText(BundleHelper.getDefaultBundleValue("edit_accession", this.getMyLocale()) + "  " +
                    getgermplasm$AccessionSessionBean().getEditAccessionDTO().getAccessionNumber());
        ...
        if (getPassportSessionBean().getPassportDTO() != null && this.isFlag_firstRendered())
        {
            if(getgermplasm$AccessionSessionBean().getEditAccessionDTO().getGerminationDate() != null)
                this.getGerminationDate().setSelectedDate(getgermplasm$AccessionSessionBean().getEditAccessionDTO().getGerminationDate().getTime());
            if(getgermplasm$AccessionSessionBean().getEditAccessionDTO().getStorageDate() != null)
                this.getStorageDate().setSelectedDate(getgermplasm$AccessionSessionBean().getEditAccessionDTO().getStorageDate().getTime());
    ...
    public String accession_movements_action()
    {
        get$AccessionMovementSessionBean().resetValues();
    ...
    public String updateAccessionButton_action() {

        setAccession();
        setPassport();
        AccessionDTO accessionDTO = getgermplasm$AccessionSessionBean().getEditAccessionDTO();
        ...
        try
        {
            ...
            MessageBean.setErrorMessageFromBundle("error_low_weight", this.getMyLocale());
            return null;
        }
    ...
    public String clearAssociatedFatherAccession()
    {
