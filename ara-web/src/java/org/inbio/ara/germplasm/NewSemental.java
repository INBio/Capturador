 ...
 *
 * @version NewSemental.java
 * @version Created on 08/04/2010, 09:47:34 AM
 * @author dasolano
 */

public class NewSemental extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("NewSemental Initialization Failure", e);
    ...
    /**
     * Performed the create Semental action.
     * @return
     */
    public String saveSemental()
    {
        try
        {
            getgermplasm$SementalSessionBean().getSementalDTO().setUserName(getAraSessionBean().getGlobalUserName());
            ...
            if (birthDateD != null)
            {
                ...
                getgermplasm$SementalSessionBean().getSementalDTO().setBirthDate(birth);
            }
