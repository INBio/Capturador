...
public class EditIndicator extends AbstractPageBean {
    ...
    public void prerender() {
        ...
        //Long idIndicator = new Long(hiddenNodeId.getValue().toString());
        //IndicatorDTO nodeInformation = this.getindicator$IndicatorSessionBean().getIndicatorDTOByIndicatorId(idIndicator);
        ...
        /*
        txIndicatorName.setText(nodeInformation.getName());
        txaIndicatorDescription.setText(nodeInformation.getDescription());        
        selectedRadioButton = nodeInformation.getAppliesToParts();
        hiddenAncestorNodeId.setValue(nodeInformation.getIndicatorAncestorId());*/
        //this.getindicator$IndicatorSessionBean().setResultRadioGroup(1L);
        //System.out.println("-----> Apply to parts actualizado (Edit) "+ this.getindicator$IndicatorSessionBean().getResultRadioGroup());
