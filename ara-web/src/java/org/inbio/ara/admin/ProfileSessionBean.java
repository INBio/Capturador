 ...
 * this class.</p>
 *
 * @version ProfileSessionBean.java
 * @version Created on 06/10/2009, 08:35:54 AM
 * @author esmata
 */
...
public class ProfileSessionBean extends AbstractSessionBean implements PaginationCoreInterface{
    ...
    //Profile DTO para edicion
    private ProfileDTO currentProfileDTO = new ProfileDTO();
    ...
    /**
     * @return the currentProfileDTO
     */
    public ProfileDTO getCurrentProfileDTO() {
        this.currentProfileDTO.setUserName(this.getAraSessionBean().getGlobalUserName());
        return currentProfileDTO;
    }

    /**
     * @param currentProfileDTO the currentProfileDTO to set
     */
    public void setCurrentProfileDTO(ProfileDTO currentProfileDTO) {
        this.currentProfileDTO = currentProfileDTO;
    }
