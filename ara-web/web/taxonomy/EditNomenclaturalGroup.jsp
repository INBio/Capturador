                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <h:outputLabel id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" value="#{resources.titleNomenclaturalGroupEdit}"/>
                                <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; position: relative" width="850">
                                    ...
                                    <webuijsf:panelLayout id="PanelDetails" style="height: 192px; position: relative; width: 840px; -rave-layout: grid" styleClass="My_subpanel_blue">
                                        ...
                                        <webuijsf:dropDown binding="#{taxonomy$EditNomenclaturalGroup.ddCollection}" id="ddCollection"
                                            ...
                                            required="true" style="height: 24px; left: 192px; top: 154px; position: absolute" width="195px"/>
