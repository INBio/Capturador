                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <webuijsf:label id="lbDetailNewTitle" style="height: 24px; left: 24px; top: 24px; position: absolute; width: 850px"
                                styleClass="Page_title" text="#{resources.new_gath_detail}: #{inventory$GatheringDetailSessionBean.currentGathering.gatheringObservationId}"/>
                            <h:panelGrid id="gridpNewDetail" style="height: 24px; left: 24px; top: 48px; position: absolute" width="850">
