                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <webuijsf:label id="lbTitle" style="height: 24px; left: 24px; top: 24px; position: absolute; width: 850px" styleClass="Page_title" text="#{resources.title_profiles_edit}"/>
                            <h:panelGrid columns="1" id="gridpMain" style="left: 24px; top: 48px; position: absolute" width="850">
                                ...
                                <webuijsf:panelLayout id="layoutPanel1" style="height: 116px; position: relative; width: 431px; -rave-layout: grid" styleClass="My_panel_blue">
                                    ...
                                    <webuijsf:textField binding="#{admin$EditProfile.txName}" columns="29" id="txName" required="true"
                                    ...
                                    <webuijsf:textArea binding="#{admin$EditProfile.txaDescription}" columns="27" id="txaDescription" required="true"
