                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <h:outputLabel id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" value="#{resources.title_institutions_new}"/>
                                <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; position: relative" width="850">
                                    ...
                                    <webuijsf:panelGroup id="grouppBotonera" style="height: 24px; width: 840px">
                                        <h:commandButton action="#{admin$NewInstitution.btnSaveInstitution_action}" id="btnSaveInstitution"
                                    ...
                                    <webuijsf:panelLayout id="layoutpDetails" style="height: 192px; width: 840px; -rave-layout: grid" styleClass="My_panel_blue">
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txName}" columns="25" id="txName" required="true"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txPhone}" columns="25" id="txPhone"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txFax}" columns="25" id="txFax"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txCountry}" columns="25" id="txCountry"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txProvince}" columns="25" id="txProvince"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txCity}" columns="25" id="txCity"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txAdreess}" columns="25" id="txAdreess"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txInstitutionCode}" columns="25" id="txInstitutionCode"
                                        ...
                                        <webuijsf:textField binding="#{admin$NewInstitution.txAcronym}" columns="25" id="txAcronym"
                                        ...
                                        <webuijsf:textArea binding="#{admin$NewInstitution.taURL}" columns="24" id="taURL"
