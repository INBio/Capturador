                    ...
                    <div id="pageFormated">
                        ...
                        <webuijsf:panelLayout id="contenido">
                            <webuijsf:form id="form1">
                                <h:outputLabel id="lbTitle" style="height: 24px; left: 24px; position: relative; width: 850px" styleClass="Page_title" value="#{resources.title_audience_edit}"/>
                                <h:panelGrid columns="1" id="gridpMain" style="left: 24px; position: relative" width="850">
                                    ...
                                    <webuijsf:panelLayout id="layoutPanel1" style="height: 116px; position: relative; width: 800px; -rave-layout: grid" styleClass="My_panel_blue">
                                        ...
                                        <webuijsf:textField binding="#{admin$EditAudience.txName}" columns="55" id="txName" required="true"
                                        ...
                                        <webuijsf:textArea binding="#{admin$EditAudience.txaDescription}" columns="53" id="txaDescription" required="true"
