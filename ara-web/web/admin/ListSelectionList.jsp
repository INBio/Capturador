                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            ...
                            <h:panelGrid columns="1" id="upperbar" style="height: 480px; left: 24px; position: absolute" width="850">
                                <webuijsf:label id="selectionLIst" style="height: 24px; top: 96px; left: 24px; position: absolute; width: 850px"
                                ...
                                <webuijsf:dropDown actionExpression="#{admin$ListSelectionList.onSelectionListChange}"  id="ddSelectionList"
                                    items="#{admin$SelectionListSessionBean.selectionListData.options}" style="top: 116px; position: absolute"
                            ...
                            <h:panelGrid cellspacing="1" columns="1" binding="#{admin$ListSelectionList.valuesTable}" id="valuesTable" 
                                style="height: 24px; left: 24px; top: 174px; position: absolute" styleClass="My_table" width="840">
