...
<!-- 
    Document   : EditDublinCore
    Created on : 03/09/2010, 11:32:56 AM
    Author     : dasolano
-->
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <webuijsf:label id="lbTitle" style="height: 24px; left: 24px; top: 24px; position: absolute; width: 850px" styleClass="Page_title" text="#{resources.edit_dublin_core}"/>
                            <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; top: 48px; position: absolute" width="850">
                                ...
                                <webuijsf:panelGroup id="grouppBotonera" style="height: 24px; width: 840px">
                                    <h:commandButton  id="savemetadata"
                                                      action="#{dublincore$EditDublinCore.updateDublinCore}"
                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.update_metadata}"/>
                                </webuijsf:panelGroup>

                                <h:panelGrid columns="2" >
                                    <webuijsf:label id="labelResourceType" style="width: 168px; height: 24px" text="#{resources.resource_type}"/>
                                    <webuijsf:dropDown id="dropdownResourceType"  width="250px" required="true" items="#{dublincore$EditDublinCore.resourceType.options}"
