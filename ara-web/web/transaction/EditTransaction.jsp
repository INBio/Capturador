                            ...
                            <webuijsf:form id="form1">
                                ...
                                <h:panelGrid columns="1" id="gridpMain" style="left: 24px; position: relative" width="850">
                                    ...
                                    <webuijsf:panelGroup id="grouppBotonera" style="height: 24px; width: 650px">
                                        <h:commandButton action="#{transaction$EditTransaction.btnUpdateTransaction_action}"
                                            binding="#{transaction$EditTransaction.btnUpdate}" id="btnUpdateTransaction" style="height: 24px; width: 175px"
                                            styleClass="My_Button" value="#{resources.update}"/>
                                    </webuijsf:panelGroup>
                                    <!-- Este tabSet no debe tener la propiedad selectedTab -->
                                    <webuijsf:tabSet binding="#{transaction$EditTransaction.tabSet}" id="tabSetMain" lite="true" selected="tabTransactionInfo"
                                        style="height: 212px; width: 843px" styleClass="My_panel_blue">
                                        <webuijsf:tab id="tabTransactionInfo" text="#{resources.transaction_information}">
                                            <webuijsf:panelLayout id="lpEditTransaction" style="height: 188px; position: relative; width: 835px; -rave-layout: grid">
                                                ...
                                                <webuijsf:label for="txEstimatedNumberSpecimens" id="lbEstimatedNumberSpecimens"
                                                    style="height: 24px; left: 24px; top: 72px; position: absolute; width: 190px" text="#{resources.estimated_specimen_count}"/>
                                                ...
                                                <webuijsf:label for="ddSenderInstitution" id="lbSenderInstitutionId"
                                                    style="height: 24px; left: 456px; top: 24px; position: absolute; width: 166px" text="#{resources.sender_institution}"/>
                                                <webuijsf:label for="ddSenderPerson" id="lbSenderPersonId"
                                                    style="height: 24px; left: 456px; top: 48px; position: absolute; width: 166px" text="#{resources.sender_person}"/>
                                                <webuijsf:label for="ddReceiverInstitutionId" id="lbReceiverInstitutionId"
                                                    style="height: 24px; left: 456px; top: 72px; position: absolute; width: 166px" text="#{resources.receiver_institution}"/>
                                                <webuijsf:label for="ddReceiverPerson" id="lbReceiverPersonId"
                                                    style="height: 24px; left: 456px; top: 96px; position: absolute; width: 166px" text="#{resources.receiver_person}"/>
                                                <webuijsf:label for="txTransactionTypeId" id="lbTransactionTypeId"
                                                    style="height: 24px; left: 456px; top: 120px; position: absolute; width: 166px" text="#{resources.transaction_type}"/>
                                        ...
                                        <webuijsf:tab binding="#{transaction$EditTransaction.tabAddTransactedSpecimens}" id="tabAddTransactedSpecimen" text="#{resources.add_transacted_specimen}">
                                            <h:panelGrid columns="1" id="pgAddTransactedSpecimen" style="height: 24px" width="700">
                                                <h:panelGrid columns="3" id="pgAddTransactedSpecimen2" style="height: 24px; margin-left: 20px" width="700">
                                                    <webuijsf:label for="txAddTransactedSpecimen" id="lbAddTransactedSpecimen"
                                                        style="height: 24px; width: 192px" text="#{resources.catalognumber} *"/>
                                                ...
                                                <h:panelGrid columns="4" id="pgDescription" style="height: 110px; margin-left: 20px; margin-top: 10px"
                                                    styleClass="My_subpanel_blue" width="800">
                                                    <webuijsf:label for="clDeliveryDate" id="lbDeliveryDate" style="height: 24px; width: 192px" text="#{resources.delivery_date} *"/>
                                                    <webuijsf:calendar binding="#{transaction$EditTransaction.clDeliveryDate}" columns="22"
                                                        dateFormatPattern="#{resources.date_format}" id="clDeliveryDate" style="height: 24px; width: 192px"/>
                                                    <webuijsf:label for="clReceivingDate" id="lbReceivingDate" style="height: 24px; width: 192px" text="#{resources.receiving_date}"/>
                                                    <webuijsf:calendar binding="#{transaction$EditTransaction.clReceivingDate}" columns="22"
                                                    ...
                                                    <webuijsf:dropDown id="ddTransactedSpecimenStatus"
                                                        items="#{transaction$EditTransaction.transactedSpecimenStatusData.options}"
                                                        selected="#{transaction$TransactionSessionBean.transactedSpecimenStatusId}" style="height: 24px" width="192px"/>
                                                    ...
                                                    <webuijsf:textArea columns="23" id="transactedSpecimenDescription" style="height: 40px; width: 172px" text="#{transaction$TransactionSessionBean.transactedSpecimenDescription}"/>
                                                    ...
                                                    <h:selectBooleanCheckbox binding="#{transaction$EditTransaction.cbxWaitingForReturn}"
                                                        id="cbxWaitingForReturn" label="Devolver"/>
                                                </h:panelGrid>
                                            </h:panelGrid>
                                        </webuijsf:tab>
                                    </webuijsf:tabSet>
                                    <webuijsf:panelLayout id="lpTransactedSpecimensTable" style="position: relative; width: 100%; -rave-layout: grid">
                                        ...
                                        <h:panelGrid cellspacing="1" columns="1" id="gridpTableMain" style="height: 24px" styleClass="My_table" width="840">
                                            <webuijsf:panelGroup id="grouppButtons">
                                                ...
                                                <webuijsf:panelGroup id="panelPaginacion" separator=" " style="margin-left:70px;">
                                                    <!-- Botones de acciones -->
                                                    <h:commandButton action="#{transaction$EditTransaction.btnTransactedSpecimenDelete_action}"
                                                        id="deleteButton" onclick="return deleteConfirmation();" style="margin: 2px;height: 22px"
                                                    ...
                                                    <h:commandButton action="#{transaction$TransactionSessionBean.nextResults}" id="btnNext"
                                                        rendered="#{transaction$TransactionSessionBean.pagination.isVisibleNext}"
