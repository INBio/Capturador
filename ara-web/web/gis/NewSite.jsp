                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <webuijsf:label id="lbTitle" style="height: 24px; left: 24px; top: 24px; position: absolute; width: 850px" styleClass="Page_title" text="#{resources.titleLocationNew}"/>
                            <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; top: 48px; position: absolute" width="850">
                                ...
                                <webuijsf:panelLayout id="PanelDetails" style="height: 149px; position: relative; width: 840px; -rave-layout: grid" styleClass="My_subpanel_blue">
                                    <webuijsf:label id="lbDescription" requiredIndicator="true"
                                        style="height: 24px; left: 48px; top: 14px; position: absolute; width: 164px" text="#{resources.description}"/>
                                    <webuijsf:label for="ddType" id="lbType" style="height: 24px; left: 48px; top: 67px; position: absolute; width: 164px" text="#{resources.type}"/>
                                    <webuijsf:label for="ddBaseProjection" id="lbBaseProy"
                                        style="height: 24px; left: 48px; top: 91px; position: absolute; width: 164px" text="#{resources.base_proyection}"/>
                                    <webuijsf:label for="ddDetermination" id="lbDetermination"
                                        style="height: 24px; left: 48px; top: 115px; position: absolute; width: 164px" text="#{resources.determination_method}"/>
                                    <webuijsf:textArea binding="#{gis$NewSite.txaDescription}" columns="23" id="txaDescription" required="true"
                                        style="position: absolute; left: 216px; top: 14px; width: 168px; height: 24px" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
                                    <webuijsf:dropDown binding="#{gis$NewSite.ddType}" id="ddType" items="#{gis$NewSite.typeData.options}" required="true"
                                        selected="#{gis$SiteSessionBean.selectedType}" style="position: absolute; left: 216px; top: 67px; height: 24px" width="192px"/>
                                    <webuijsf:dropDown binding="#{gis$NewSite.ddBaseProjection}" id="ddBaseProjection"
                                        ...
                                        style="position: absolute; left: 216px; top: 91px; height: 24px" width="192px"/>
                                    <webuijsf:dropDown binding="#{gis$NewSite.ddDetermination}" id="ddDetermination"
                                        ...
                                        style="position: absolute; left: 216px; top: 115px; height: 24px" width="192px"/>
                                    ...
                                    <webuijsf:label for="txDatum" id="lbDatum" style="height: 24px; left: 432px; top: 62px; position: absolute; width: 164px" text="#{resources.datum}"/>
                                ...
                                <webuijsf:tabSet id="tabSetSites" lite="true" selected="tabCoordinates" style="height: 284px; width: 840px" styleClass="My_tab_border">
                                    <webuijsf:tab id="tabCoordinates" text="#{resources.coordinates}">
                                        <webuijsf:panelLayout id="lpCoordinates" style="height: 263px; position: relative; width: 100%; -rave-layout: grid">
                                            ...
                                            <webuijsf:textField binding="#{gis$NewSite.txLongitudeDegrees}" id="txt_longitude_degrees" style="left: 120px; top: 48px; position: absolute; width: 120px"/>
                                            ...
                                            <webuijsf:textField binding="#{gis$NewSite.txLatitudeDegrees}" id="txt_latitude_degrees" style="left: 120px; top: 168px; position: absolute; width: 120px"/>
