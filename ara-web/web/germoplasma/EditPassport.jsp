...
<!--
    Document   : EditPassport
    Created on : 10/02/2010, 04:13:15 PM
    Author     : dasolano
-->
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <webuijsf:label binding="#{germoplasma$EditPassport.lbTitle}" id="lbTitle"
                                style="height: 24px; left: 24px; top: 24px; position: absolute; width: 850px" styleClass="Page_title" text="#{resources.edit_passport}"/>
                            <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; top: 48px; position: absolute" width="850">
                                ...
                                <webuijsf:panelGroup id="grouppBotoneraPassport" style="height: 24px; width: 840px">
                                    <h:commandButton action="#{germoplasma$EditPassport.updatePassportButton_action}" id="updatePassportButton"
                                        style="height: 24px; width: 175px" styleClass="My_Button" value="#{resources.update_passport}"/>
                                </webuijsf:panelGroup>
                                <!-- save button -->
                                <!-- Tab menu -->
                                    ...
                                    <webuijsf:tab id="tabGeneralInformation" text="#{resources.general_information}">
                                        <h:panelGrid columns="1" id="gridTabSet1" style="position: relative" width="840">
                                            <h:panelGrid columns="4" id="gridDonors" style="position: relative" width="840">
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownDonorPerson}" id="dropdownDonorPerson"
                                                    items="#{germoplasma$EditPassport.donorPersons.options}"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownDonorInstitution}" id="dropdownDonorInstitution"
                                                    items="#{germoplasma$EditPassport.donorInstitutions.options}"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownGatheringSource}" id="dropdownGatheringSource"
                                                    items="#{germoplasma$EditPassport.gatheringSource.options}"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownSoilColor}" id="dropdownSoilColor"
                                                    items="#{germoplasma$EditPassport.soilColosr.options}"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownSoilTexture}" id="dropdownSoilTexture"
                                                    items="#{germoplasma$EditPassport.soilTextures.options}"
                                                ...
                                                <webuijsf:textField binding="#{germoplasma$EditPassport.textFieldMissionNumber}" id="textFieldMisionNumber"
                                                ...
                                                <webuijsf:textArea binding="#{germoplasma$EditPassport.textAreaRemarks}" id="textAreaRemarks"
                                    ...
                                    <webuijsf:tab id="tabCropAndSample" text="#{resources.sample_crop}">
                                        <h:panelGrid columns="1" id="gridTabSet2" style="position: relative;" width="840">
                                            <h:panelGrid columns="2" id="gridTaxonomy" style="position: relative;" styleClass="My_panel_blue" width="840">
                                                <h:panelGrid columns="2" id="gTaxonomy" style="position: relative;">
                                                    ...
                                                    <webuijsf:dropDown
                                                        ...
                                                        binding="#{germoplasma$EditPassport.dropdownTaxonomicaLevel}" id="dropdownTaxonomicLevel"
                                                        items="#{germoplasma$EditPassport.taxonomicLevels.options}"
                                                    ...
                                                    <webuijsf:dropDown actionExpression="#{germoplasma$NewPassport.updateNomenclaturalGroupListAction}"
                                                        binding="#{germoplasma$EditPassport.dropdownScientificName}" id="dropdownScientificName"
                                                        items="#{germoplasma$EditPassport.scientificNames.options}"
                                            ...
                                            <h:panelGrid columns="4" id="gridSampleAndCrop" style="position: relative; top:10" width="840">
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownMaterialType}" id="dropdownMaterialType"
                                                    items="#{germoplasma$EditPassport.materialTypes.options}"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownCultivationPractice}"
                                                    id="dropdownultivationPractice" items="#{germoplasma$EditPassport.cultivationPractice.options}"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownSampleStatus}" id="dropdownSampleStatus"
                                                    items="#{germoplasma$EditPassport.sampleStatus.options}"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownCropType}" id="dropdownCropType"
                                                    items="#{germoplasma$EditPassport.cropTypes.options}"
                                                ...
                                                <webuijsf:calendar binding="#{germoplasma$EditPassport.plantNurseryDate}" dateFormatPattern="dd/MM/yyyy"
                                                ...
                                                <webuijsf:dropDown binding="#{germoplasma$EditPassport.dropdownCropSystem}" id="dropdownCropSystem"
                                                    items="#{germoplasma$EditPassport.cropSystems.options}"
                                                ...
                                                <webuijsf:calendar binding="#{germoplasma$EditPassport.plantationDate}" dateFormatPattern="dd/MM/yyyy"
                                                ...
                                                <webuijsf:textField binding="#{germoplasma$EditPassport.textFieldResist}" id="textFieldCropResistence"
                                                ...
                                                <webuijsf:calendar binding="#{germoplasma$EditPassport.harvestingDate}" dateFormatPattern="dd/MM/yyyy"
                                                    id="calendarHarvestingDate" style="width: 200px"/>
                                            </h:panelGrid>
                                        </h:panelGrid>
                                    </webuijsf:tab>
                                    <webuijsf:tab id="tabRecoleccion" text="#{resources.gathering}">
                                        <h:panelGrid columns="1" id="gridAgrupacion" style="position: relative" styleClass="My_panel_blue" width="850">
                                            ...
                                            <h:panelGrid columns="3" id="gridpSearch" style="height: 24px" width="719">
                                                <h:inputText binding="#{germoplasma$EditPassport.txSearch}" id="txSearch" style="height: 18px; width: 408px">
                                                    <f:validateLength maximum="100" minimum="0"/>
                                                </h:inputText>
                                                <h:commandButton action="#{germoplasma$EditPassport.btnGatheringSearch_action}"
                                                    binding="#{germoplasma$EditPassport.btnSeach}" id="btnGatheringSearch" style="height: 25px; width: 160px"
                                                    styleClass="My_Button" value="#{resources.search}"/>
                                                <h:commandButton action="#{germoplasma$EditPassport.btnAdvGatheringSearch_action}"
                                                    binding="#{germoplasma$EditPassport.btnAdvSeach}" id="btnAdvGatheringSearch"
                                                    style="height: 25px; width: 160px" styleClass="My_Button" value="#{resources.advanced_search}"/>
                                            </h:panelGrid>
                                            <h:panelGrid binding="#{germoplasma$EditPassport.gridpAdvancedSearch}" columns="1" id="gridpAdvancedSearch"
                                                ...
                                                <h:panelGrid columns="4" id="gridpAdvancedSearch1" style="height: 24px" width="670">
                                                    ...
                                                    <webuijsf:calendar binding="#{germoplasma$EditPassport.initial_date}" columns="15"
                                                        dateFormatPattern="yyyy-MM-dd" id="initialDateCalendar"/>
                                                    <webuijsf:label for="finalDateCalendar" text="#{resources.final_date}"/>
                                                    <webuijsf:calendar binding="#{germoplasma$EditPassport.final_date}" columns="15"
                                                    ...
                                                    <webuijsf:textField binding="#{germoplasma$EditPassport.txGatheringId}" id="txGatheringId" validatorExpression="#{util$ValidatorBean.longNumberFormatValidator}"/>
                                                    <webuijsf:label for="txResponsible" id="lbResponsible" text="#{resources.person_in_charge}"/>
                                                    <webuijsf:textField binding="#{germoplasma$EditPassport.txResponsible}" id="txResponsible" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
                                                    <webuijsf:label for="ddCountry" id="lbCountry" text="#{resources.country}"/>
                                                    <webuijsf:dropDown actionExpression="#{germoplasma$EditPassport.setProvinces}"
                                                        binding="#{germoplasma$EditPassport.ddCountry}" id="ddCountry"
                                                        items="#{germoplasma$EditPassport.countryData.options}"
                                                    ...
                                                    <webuijsf:dropDown binding="#{germoplasma$EditPassport.ddProvince}" id="ddProvince"
                                                        items="#{germoplasma$EditPassport.provincesData.options}"
                                                    ...
                                                    <webuijsf:textField binding="#{germoplasma$EditPassport.txLocality}" id="txLocality" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
                                                </h:panelGrid>
                                                <h:panelGrid cellspacing="1" columns="2" id="panelpCoordinates" width="670">
                                                    <h:panelGrid columns="7" id="gridpanelCoor" style="height: 24px" styleClass="My_subpanel_blue" width="500">
                                                        ...
                                                        <webuijsf:textField binding="#{germoplasma$EditPassport.txLatitudeShort}" columns="10"
                                                        ...
                                                        <webuijsf:textField binding="#{germoplasma$EditPassport.txLongitudeShort}" columns="10"
                                                        ...
                                                        <webuijsf:textField binding="#{germoplasma$EditPassport.txRadio}" columns="10" id="txRadio" validatorExpression="#{util$ValidatorBean.longNumberFormatValidator}">
                                                            <f:validateLongRange maximum="2147483647" minimum="0"/>
                                                        </webuijsf:textField>
                                                    </h:panelGrid>
                                                    <h:commandButton action="#{germoplasma$EditPassport.btnAdvSearchGO_action}" id="btnAdvSearchGO"
                                                ...
                                                <h:panelGrid cellspacing="1" columns="1" id="gridpTableMain" style="height: 24px" styleClass="My_table" width="840">
                                                    <webuijsf:panelGroup id="grouppButtons">
                                                        <h:panelGrid columns="1" id="gridpquantity" styleClass="My_table_top" width="840">
                                                            <h:outputLabel id="labelQuantity" value="#{germoplasma$EditPassport.quantityTotal}"/>
                                                        </h:panelGrid>
                                                    ...
                                                    <h:dataTable binding="#{germoplasma$EditPassport.dataTableGathering}" cellspacing="0"
