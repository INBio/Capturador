                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <webuijsf:label id="lbNewTitle" style="height: 24px; left: 24px; top: 24px; position: absolute; width: 850px"
                                styleClass="Page_title" text="#{resources.new_user}"/>
                            <h:panelGrid columns="1" id="gridpGenerationMain" style="height: 24px; left: 24px; top: 48px; position: absolute" width="768">
                                ...
                                <webuijsf:panelLayout id="layoutPanelDetail" style="height: 128px; position: relative; width: 750px; -rave-layout: grid" styleClass="My_panel_blue">
                                    ...
                                    <webuijsf:label for="pfPassword" id="lbPassword"
                                        style="height: 24px; left: 384px; top: 24px; position: absolute; width: 168px" text="#{resources.password}"/>
                                    <webuijsf:passwordField binding="#{security$NewUser.pfPassword}" columns="24" id="pfPassword" required="true"
                                        style="height: 24px; left: 552px; top: 24px; position: absolute; width: 144px" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}">
                                        <f:validateLength maximum="8" minimum="4"/>
                                    </webuijsf:passwordField>
                                    <webuijsf:label for="pfConfirmPass" id="lbConfirmPass"
                                        style="height: 24px; left: 384px; top: 72px; position: absolute; width: 168px" text="#{resources.confirm_new_password}"/>
                                    <webuijsf:passwordField binding="#{security$NewUser.pfConfirmPass}" columns="24" id="pfConfirmPass" required="true"
                                        style="height: 24px; left: 552px; top: 72px; position: absolute; width: 144px" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}">
                                        <f:validateLength maximum="8" minimum="4"/>
                                    </webuijsf:passwordField>
