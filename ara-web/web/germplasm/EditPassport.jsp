                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                            <webuijsf:label binding="#{germplasm$EditPassport.lbTitle}" id="lbTitle"
                            ...
                            <h:panelGrid columns="1" id="gridpMain" style="height: 24px; left: 24px; top: 48px; position: absolute" width="850">
                                ...
                                <webuijsf:panelGroup id="grouppBotoneraPassport" style="height: 24px; width: 840px">
                                    <h:commandButton action="#{germplasm$EditPassport.updatePassportButton_action}" id="updatePassportButton"
                                    ...
                                    <webuijsf:tab id="tabRecoleccion" text="#{resources.gathering}">
                                        <h:panelGrid columns="1" id="gridAgrupacion" style="position: relative" styleClass="My_panel_blue" width="850">
                                            ...
                                            <h:panelGrid columns="3" id="gridpSearch" style="height: 24px" width="719">
                                                <h:inputText binding="#{germplasm$EditPassport.txSearch}" id="txSearch" style="height: 18px; width: 408px">
                                                    <f:validateLength maximum="100" minimum="0"/>
                                                </h:inputText>
                                                <h:commandButton action="#{germplasm$EditPassport.btnGatheringSearch_action}"
                                                    binding="#{germplasm$EditPassport.btnSeach}" id="btnGatheringSearch" style="height: 25px; width: 160px"
                                                    styleClass="My_Button" value="#{resources.search}"/>
                                                <h:commandButton action="#{germplasm$EditPassport.btnAdvGatheringSearch_action}"
                                                    binding="#{germplasm$EditPassport.btnAdvSeach}" id="btnAdvGatheringSearch"
                                                    style="height: 25px; width: 160px" styleClass="My_Button" value="#{resources.advanced_search}"/>
                                            </h:panelGrid>
                                            <h:panelGrid binding="#{germplasm$EditPassport.gridpAdvancedSearch}" columns="1" id="gridpAdvancedSearch"
                                                ...
                                                <h:panelGrid columns="4" id="gridpAdvancedSearch1" style="height: 24px" width="670">
                                                    ...
                                                    <webuijsf:calendar binding="#{germplasm$EditPassport.initial_date}" columns="15"
                                                        dateFormatPattern="yyyy-MM-dd" id="initialDateCalendar"/>
                                                    <webuijsf:label for="finalDateCalendar" text="#{resources.final_date}"/>
                                                    <webuijsf:calendar binding="#{germplasm$EditPassport.final_date}" columns="15"
                                                    ...
                                                    <webuijsf:textField binding="#{germplasm$EditPassport.txGatheringId}" id="txGatheringId" validatorExpression="#{util$ValidatorBean.longNumberFormatValidator}"/>
                                                    <webuijsf:label for="txResponsible" id="lbResponsible" text="#{resources.person_in_charge}"/>
                                                    <webuijsf:textField binding="#{germplasm$EditPassport.txResponsible}" id="txResponsible" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
                                                    <webuijsf:label for="ddCountry" id="lbCountry" text="#{resources.country}"/>
                                                    <webuijsf:dropDown actionExpression="#{germplasm$EditPassport.setProvinces}"
                                                        binding="#{germplasm$EditPassport.ddCountry}" id="ddCountry"
                                                        items="#{germplasm$EditPassport.countryData.options}"
                                                    ...
                                                    <webuijsf:dropDown binding="#{germplasm$EditPassport.ddProvince}" id="ddProvince"
                                                        items="#{germplasm$EditPassport.provincesData.options}"
                                                    ...
                                                    <webuijsf:textField binding="#{germplasm$EditPassport.txLocality}" id="txLocality" validatorExpression="#{util$ValidatorBean.validateInputStringGeneric}"/>
                                                </h:panelGrid>
                                                <h:panelGrid cellspacing="1" columns="2" id="panelpCoordinates" width="670">
                                                    <h:panelGrid columns="7" id="gridpanelCoor" style="height: 24px" styleClass="My_subpanel_blue" width="500">
                                                        ...
                                                        <webuijsf:textField binding="#{germplasm$EditPassport.txLatitudeShort}" columns="10"
                                                        ...
                                                        <webuijsf:textField binding="#{germplasm$EditPassport.txLongitudeShort}" columns="10"
                                                        ...
                                                        <webuijsf:textField binding="#{germplasm$EditPassport.txRadio}" columns="10" id="txRadio" validatorExpression="#{util$ValidatorBean.longNumberFormatValidator}">
                                                            <f:validateLongRange maximum="2147483647" minimum="0"/>
                                                        </webuijsf:textField>
                                                    </h:panelGrid>
                                                    <h:commandButton action="#{germplasm$EditPassport.btnAdvSearchGO_action}" id="btnAdvSearchGO"
                                                ...
                                                <h:panelGrid cellspacing="1" columns="1" id="gridpTableMain" style="height: 24px" styleClass="My_table" width="840">
                                                    <webuijsf:panelGroup id="grouppButtons">
                                                        <h:panelGrid columns="1" id="gridpquantity" styleClass="My_table_top" width="840">
                                                            <h:outputLabel id="labelQuantity" value="#{germplasm$EditPassport.quantityTotal}"/>
                                                        </h:panelGrid>
                                                    ...
                                                    <h:dataTable binding="#{germplasm$EditPassport.dataTableGathering}" cellspacing="0"
