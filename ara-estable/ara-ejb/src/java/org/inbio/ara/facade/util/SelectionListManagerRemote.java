...
public interface SelectionListManagerRemote {
    ...
    org.inbio.ara.persistence.specimen.IdentificationType getIdentificationTypeById(Long identificationTypeId);
    ...
    com.sun.webui.jsf.model.Option[] getTypeSpecimenType();

    org.inbio.ara.persistence.specimen.TypeSpecimenType getTypeSpecimenTypeId(Long id);
    ...
    * @param collectionsId una lista de los id's de las colecciones que deben estar
    *        asociadas al valor de la lista de seleccion.
    */
    public void updateCollectionsBySelectionListValue(Long selectionListId, Long selectionListValueId, List<Long> collectionsId);

    /**
     * Deberia estar en el ListTableCollectionDAO o EAO
     *
     * @param selectionListId
     * @param selectionListValueId
     * @param CollectionId
  ...
  /**
    ...
    /**
     * Esto debería estar en el SelectionListValueDAO o EAO
     * 
     * @param selectionListId
     * @param selectionListValueId 
     * @return
   ...
   /**
     *
     * @param selectionListId
     * @return selectionListEntity that could be used for the selectionList which Id is given as parameter
     */
