                ...
                <webuijsf:body binding="#{identification$listIdentification.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{identification$listIdentification.form1}" id="form1">
                            ...
                            <webuijsf:table binding="#{identification$listIdentification.table1}" clearSortButton="true" id="table1" paginateButton="true"
                                paginationControls="true" sortPanelToggleButton="true" style="left: 48px; top: 72px; position: absolute; width: 835px"
                                title="#{resources.identifications}" width="835">
                                <webuijsf:tableRowGroup binding="#{identification$listIdentification.tableRowGroup1}" id="tableRowGroup1" rows="15"
                                    sourceData="#{identification$IdentificationSessionBean.identificationDataProvider}" sourceVar="currentRow">
                                    ...
                                    <webuijsf:tableColumn binding="#{identification$listIdentification.tableColumn5}" headerText="#{resources.badge}"
                                ...
                                <f:facet name="actionsTop">
                                    <webuijsf:button actionExpression="#{identification$listIdentification.btn_reIdentify_action}"
                                        binding="#{identification$listIdentification.btn_reIdentify}" id="btn_reIdentify" text="#{resources.re_identify}"/>
                                </f:facet>
                            </webuijsf:table>
                        </webuijsf:form>
