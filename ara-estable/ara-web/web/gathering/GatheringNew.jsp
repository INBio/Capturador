                ...
                <webuijsf:body binding="#{gathering$GatheringNew.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{gathering$GatheringNew.form1}" id="form1">
                            ...
                            <webuijsf:panelLayout binding="#{gathering$GatheringNew.layoutPanel1}" id="layoutPanel1" style="height: 310px; left: 48px; top: 72px; position: absolute; width: 646px; -rave-layout: grid">
                                ...
                                <webuijsf:dropDown binding="#{gathering$GatheringNew.dd_site}" id="dd_site" items="#{gathering$GatheringSessionBeanV2.sites}"
                                    selected="#{gathering$GatheringSessionBeanV2.selectedSite}" style="left: 144px; top: 24px; position: absolute; width: 479px"/>
                                <webuijsf:calendar binding="#{gathering$GatheringNew.cal_initialDate}" dateFormatPattern="dd/MM/yyyy"
                                    dateFormatPatternHelp="dd/mm/yyyy" id="cal_initialDate" style="left: 144px; top: 48px; position: absolute"/>
                                <webuijsf:calendar binding="#{gathering$GatheringNew.cal_finalDate}" dateFormatPattern="dd/MM/yyyy"
                                    dateFormatPatternHelp="dd/mm/yyyy" id="cal_finalDate" style="left: 432px; top: 48px; position: absolute"/>
                                <webuijsf:dropDown binding="#{gathering$GatheringNew.dd_responsiblePerson}" id="dd_responsiblePerson"
                                    ...
                                    selected="#{gathering$GatheringSessionBeanV2.selectedResponsiblePerson}" style="left: 144px; top: 96px; position: absolute; width: 287px"/>
                                ...
                                <webuijsf:staticText binding="#{gathering$GatheringNew.staticText2}" id="staticText2"
                                    style="left: 192px; top: 120px; position: absolute; width: 45px" text="#{resources.minimum}"/>
                                <webuijsf:staticText binding="#{gathering$GatheringNew.staticText3}" id="staticText3"
                                    style="left: 192px; top: 144px; position: absolute; width: 45px" text="#{resources.maximum}"/>
                                <webuijsf:label binding="#{gathering$GatheringNew.label8}" id="label8"
                                    style="left: 264px; top: 120px; position: absolute; width: 69px" text="#{resources.depth}"/>
                                <webuijsf:staticText binding="#{gathering$GatheringNew.staticText4}" id="staticText4"
                                    style="left: 408px; top: 144px; position: absolute; width: 45px" text="#{resources.maximum}"/>
                                <webuijsf:textField binding="#{gathering$GatheringNew.txt_minDepth}" columns="4" id="txt_minDepth" style="left: 360px; top: 120px; position: absolute; width: 47px"/>
                                <webuijsf:staticText binding="#{gathering$GatheringNew.staticText5}" id="staticText5"
                                    style="left: 408px; top: 120px; position: absolute; width: 45px" text="#{resources.minimum}"/>
                                <webuijsf:textField binding="#{gathering$GatheringNew.txt_maxDept}" columns="4" id="txt_maxDept" style="left: 360px; top: 144px; position: absolute; width: 47px"/>
                                <webuijsf:label binding="#{gathering$GatheringNew.label9}" id="label9"
                                    style="left: 480px; top: 120px; position: absolute; width: 93px" text="#{resources.gradient}"/>
                                <webuijsf:textField binding="#{gathering$GatheringNew.txt_Gradient}" columns="6" id="txt_Gradient" style="left: 576px; top: 120px; position: absolute; width: 47px"/>
                                <webuijsf:label binding="#{gathering$GatheringNew.label10}" id="label10"
                                    style="left: 480px; top: 144px; position: absolute; width: 93px" text="#{resources.exposition}"/>
                                <webuijsf:dropDown binding="#{gathering$GatheringNew.dd_Exposition}" id="dd_Exposition"
                                    items="#{gathering$GatheringSessionBeanV2.expositions}" selected="#{gathering$GatheringSessionBeanV2.selectedExposition}" style="left: 576px; top: 144px; position: absolute; width: 95px"/>
                                <webuijsf:label binding="#{gathering$GatheringNew.label11}" id="label11" style="left: 24px; top: 168px; position: absolute" text="#{resources.surroundings_description}"/>
                                <webuijsf:label binding="#{gathering$GatheringNew.label12}" id="label12" style="left: 336px; top: 168px; position: absolute" text="#{resources.site_description}"/>
                                <webuijsf:textArea binding="#{gathering$GatheringNew.txt_surroundings}" id="txt_surroundings" style="height: 119px; left: 24px; top: 192px; position: absolute; width: 263px"/>
                                <webuijsf:textArea binding="#{gathering$GatheringNew.txt_siteDesc}" id="txt_siteDesc" style="height: 119px; left: 336px; top: 192px; position: absolute; width: 288px"/>
                            ...
                            <webuijsf:tabSet binding="#{gathering$GatheringNew.tabSet_gathering}" id="tabSet_gathering" selected="tab_Collectors" style="border: 1px solid gray; height: 334px; left: 48px; top: 360px; position: absolute; width: 694px">
                            ...
                            <webuijsf:button actionExpression="#{gathering$GatheringNew.btn_cancel_action}" binding="#{gathering$GatheringNew.btn_cancel}"
                                id="btn_cancel" style="height: 24px; left: 191px; top: 768px; position: absolute; width: 72px" text="#{resources.btnBack}"/>
                        </webuijsf:form>
                    </webuijsf:panelLayout>
