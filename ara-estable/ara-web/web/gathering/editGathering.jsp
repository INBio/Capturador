                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{gathering$editGathering.form1}" id="form1">
                            <webuijsf:button actionExpression="#{gathering$editGathering.btn_save_action}" binding="#{gathering$editGathering.btn_save}"
                                id="btn_save" style="height: 24px; left: 527px; top: 24px; position: absolute; width: 96px" text="#{resources.btnUpdate}"/>
                            <h:messages binding="#{gathering$editGathering.messageList1}" errorClass="errorMessage" fatalClass="fatalMessage" id="messageList1"
                                infoClass="infoMessage" style="left: 672px; top: 24px; position: absolute; width: 214px" warnClass="warnMessage"/>
                            <webuijsf:panelLayout binding="#{gathering$editGathering.layoutPanel1}" id="layoutPanel1" style="border: 1px solid gray; height: 286px; left: 48px; top: 72px; position: absolute; width: 838px; -rave-layout: grid">
                                ...
                                <webuijsf:label binding="#{gathering$editGathering.label3}" id="label3" requiredIndicator="true"
                                    style="left: 336px; top: 72px; position: absolute" text="#{resources.final_date}"/>
                                ...
                                <webuijsf:dropDown binding="#{gathering$editGathering.dd_responsiblePerson}"
                                    ...
                                    style="left: 144px; top: 120px; position: absolute; width: 200px" width="178px"/>
                                ...
                                <webuijsf:staticText binding="#{gathering$editGathering.staticText1}" id="staticText1"
                                    style="left: 216px; top: 144px; position: absolute; width: 45px" text="#{resources.minimum}"/>
                                <webuijsf:staticText binding="#{gathering$editGathering.staticText2}" id="staticText2"
                                    style="left: 216px; top: 168px; position: absolute; width: 45px" text="#{resources.maximum}"/>
                                <webuijsf:label binding="#{gathering$editGathering.label7}" id="label7"
                                    style="left: 336px; top: 144px; position: absolute; width: 69px" text="#{resources.depth}"/>
                                <webuijsf:staticText binding="#{gathering$editGathering.staticText3}" id="staticText3"
                                    style="left: 504px; top: 168px; position: absolute; width: 45px" text="#{resources.maximum}"/>
                                <webuijsf:textField binding="#{gathering$editGathering.txt_minDepth}" columns="4"
                                    converter="#{gathering$editGathering.longConverter1}" id="txt_minDepth" style="left: 432px; top: 144px; position: absolute; width: 47px"/>
                                <webuijsf:staticText binding="#{gathering$editGathering.staticText4}" id="staticText4"
                                    style="left: 504px; top: 144px; position: absolute; width: 45px" text="#{resources.minimum}"/>
                                <webuijsf:textField binding="#{gathering$editGathering.txt_maxDept}" columns="4"
                                    converter="#{gathering$editGathering.longConverter1}" id="txt_maxDept" style="left: 432px; top: 168px; position: absolute; width: 47px"/>
                                <webuijsf:label binding="#{gathering$editGathering.label8}" id="label8"
                                    style="left: 624px; top: 144px; position: absolute; width: 93px" text="#{resources.gradient}"/>
                                <webuijsf:textField binding="#{gathering$editGathering.txt_Gradient}" columns="6"
                                    converter="#{gathering$editGathering.longConverter1}" id="txt_Gradient" style="left: 720px; top: 144px; position: absolute; width: 50px"/>
                                <webuijsf:label binding="#{gathering$editGathering.label9}" id="label9"
                                    style="left: 624px; top: 168px; position: absolute; width: 93px" text="#{resources.exposition}"/>
                                <webuijsf:dropDown binding="#{gathering$editGathering.dd_Exposition}" converter="#{gathering$GatheringNew.longConverter1}"
                                    ...
                                    selected="#{gathering$GatheringSessionBeanV2.selectedExposition}"
                                    style="left: 720px; top: 168px; position: absolute; width: 50px" width="50px"/>
                                <webuijsf:label binding="#{gathering$editGathering.label10}" id="label10" style="left: 144px; top: 192px; position: absolute" text="#{resources.surroundings_description}"/>
                                <webuijsf:label binding="#{gathering$editGathering.label11}" id="label11" style="left: 432px; top: 192px; position: absolute" text="#{resources.site_description}"/>
                                <webuijsf:textArea binding="#{gathering$editGathering.txt_surroundings}" id="txt_surroundings" style="height: 60px; left: 144px; top: 216px; position: absolute; width: 263px"/>
                                <webuijsf:textArea binding="#{gathering$editGathering.txt_siteDesc}" id="txt_siteDesc" style="height: 60px; left: 432px; top: 216px; position: absolute; width: 288px"/>
                            ...
                            <webuijsf:tabSet binding="#{gathering$editGathering.tabSet_gathering}" id="tabSet_gathering" selected="tab_Collectors" style="border: 1px solid gray; height: 310px; left: 48px; top: 384px; position: absolute; width: 838px">
                                <webuijsf:tab binding="#{gathering$editGathering.tab_Collectors}" id="tab_Collectors" text="#{resources.collectors}">
                                    <webuijsf:panelLayout binding="#{gathering$editGathering.layoutPanel2}" id="layoutPanel2" style="height: 296px; position: relative; width: 100%; -rave-layout: grid">
                                        <webuijsf:addRemove availableItemsLabel="#{resources.available}" binding="#{gathering$editGathering.ar_Collectors}"
                                            ...
                                            selected="#{gathering$GatheringSessionBeanV2.selectedCollectors}" selectedItemsLabel="#{resources.selected}"
                                            style="height: 238px; left: 24px; top: 24px; position: absolute; visibility: visible; z-index: 10; weight: 380" styleClass="TblHdrTxt"/>
                                    </webuijsf:panelLayout>
                                </webuijsf:tab>
                            ...
                            <webuijsf:button actionExpression="#{gathering$editGathering.btn_specimenGeneration_action}"
                                ...
                                style="height: 24px; left: 407px; top: 24px; position: absolute; width: 96px" text="#{resources.specimens}"/>
                        </webuijsf:form>
                    </webuijsf:panelLayout>
