                ...
                <webuijsf:body binding="#{nomenclaturalgroup$newNomenclaturalGroup.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{nomenclaturalgroup$newNomenclaturalGroup.form1}" id="form1">
                            ...
                            <webuijsf:textField binding="#{nomenclaturalgroup$newNomenclaturalGroup.txt_name}" id="txt_name" style="left: 144px; top: 72px; position: absolute"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$newNomenclaturalGroup.label3}" id="label3"
                                style="left: 48px; top: 96px; position: absolute" text="#{resources.description}"/>
                            <webuijsf:textArea binding="#{nomenclaturalgroup$newNomenclaturalGroup.txt_description}" id="txt_description" style="height: 48px; left: 144px; top: 96px; position: absolute; width: 408px"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$newNomenclaturalGroup.label4}" id="label4"
                                style="left: 48px; top: 144px; position: absolute" text="#{resources.colection}"/>
                            <webuijsf:dropDown binding="#{nomenclaturalgroup$newNomenclaturalGroup.dd_collection}" id="dd_collection"
                                ...
                                selected="#{nomenclaturalgroup$NomenclaturalGroupSessionBean.selectedCollection}" style="left: 144px; top: 144px; position: absolute"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$newNomenclaturalGroup.label5}" id="label5"
                                style="left: 48px; top: 168px; position: absolute" text="#{resources.certifier}"/>
                            <webuijsf:dropDown binding="#{nomenclaturalgroup$newNomenclaturalGroup.dd_certificador}" id="dd_certificador"
                                ...
                                selected="#{nomenclaturalgroup$NomenclaturalGroupSessionBean.selectedCertificator}" style="left: 144px; top: 168px; position: absolute"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$newNomenclaturalGroup.label6}" id="label6"
                                style="left: 48px; top: 192px; position: absolute" text="#{resources.notes}"/>
                            <webuijsf:textArea binding="#{nomenclaturalgroup$newNomenclaturalGroup.txt_notes}" id="txt_notes" style="height: 48px; left: 144px; top: 192px; position: absolute; width: 408px"/>
                            <webuijsf:tabSet binding="#{nomenclaturalgroup$newNomenclaturalGroup.tabSet1}" id="tabSet1" selected="tab_taxon" style="border: 1px solid gray; height: 36px; left: 48px; top: 288px; position: absolute; width: 766px">
                                <webuijsf:tab binding="#{nomenclaturalgroup$newNomenclaturalGroup.tab_taxon}" id="tab_taxon" text="#{resources.taxons}">
                                    <webuijsf:panelLayout binding="#{nomenclaturalgroup$newNomenclaturalGroup.layoutPanel1}" id="layoutPanel1" style="height: 274px; position: relative; width: 100%; -rave-layout: grid">
                                ...
                                <webuijsf:tab binding="#{nomenclaturalgroup$newNomenclaturalGroup.tab_region}" id="tab_region" text="#{resources.regions}">
                                    <webuijsf:panelLayout binding="#{nomenclaturalgroup$newNomenclaturalGroup.layoutPanel2}" id="layoutPanel2" style="height: 272px; position: relative; width: 100%; -rave-layout: grid">
                                        <webuijsf:addRemove availableItemsLabel="#{resources.availables}:"
                            ...
                            <webuijsf:button actionExpression="#{nomenclaturalgroup$newNomenclaturalGroup.btn_save_action}"
                                ...
                                style="height: 24px; left: 623px; top: 96px; position: absolute; width: 47px" text="#{resources.btnSave}"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$newNomenclaturalGroup.label7}" id="label7"
                                style="left: 48px; top: 240px; position: absolute" text="#{resources.temporality}"/>
                            <webuijsf:textField binding="#{nomenclaturalgroup$newNomenclaturalGroup.txt_temporality}" id="txt_temporality" style="left: 144px; top: 240px; position: absolute"/>
                            <webuijsf:dropDown binding="#{nomenclaturalgroup$newNomenclaturalGroup.dd_commonName}" id="dd_commonName"
                                items="#{nomenclaturalgroup$newNomenclaturalGroup.dd_commonNameDefaultOptions.options}" label="#{resources.common_name}" style="left: 360px; top: 72px; position: absolute"/>
                        </webuijsf:form>
                    </webuijsf:panelLayout>
