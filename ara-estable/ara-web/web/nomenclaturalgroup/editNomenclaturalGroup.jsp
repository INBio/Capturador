                    ...
                    <webuijsf:panelLayout id="contenido" style="position: relative; -rave-layout: grid">
                        <webuijsf:form binding="#{nomenclaturalgroup$editNomenclaturalGroup.form1}" id="form1">
                            <webuijsf:label binding="#{nomenclaturalgroup$editNomenclaturalGroup.label1}" id="label1"
                                style="font-size: 24px; height: 22px; left: 48px; top: 17px; position: absolute; width: 550px" text="#{resources.edit_nomenclatural_group}"/>
                            <webuijsf:textField binding="#{nomenclaturalgroup$editNomenclaturalGroup.txt_name}" id="txt_name" style="left: 144px; top: 72px; position: absolute"/>
                            <webuijsf:textField binding="#{nomenclaturalgroup$editNomenclaturalGroup.txt_temporality}" id="txt_temporality" style="left: 144px; top: 264px; position: absolute"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$editNomenclaturalGroup.label2}" id="label2"
                                style="left: 48px; top: 264px; position: absolute" text="#{resources.temporality}"/>
                            <webuijsf:dropDown binding="#{nomenclaturalgroup$editNomenclaturalGroup.dd_collection}" id="dd_collection"
                                ...
                                style="left: 144px; top: 168px; position: absolute"/>
                            <!--
                            ...
                            -->
                            <webuijsf:button id="btn_actualizar" text="#{resources.btnUpdate}" 
                                style="left: 623px; top: 168px; position: absolute"
                                actionExpression="#{nomenclaturalgroup$editNomenclaturalGroup.btn_update}"/>
                            ...
                            <webuijsf:dropDown binding="#{nomenclaturalgroup$editNomenclaturalGroup.dd_certificador}" id="dd_certificador"
                                ...
                                selected="#{nomenclaturalgroup$NomenclaturalGroupSessionBean.selectedCertificator}" style="left: 144px; top: 192px; position: absolute"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$editNomenclaturalGroup.label4}" id="label4"
                                style="left: 48px; top: 168px; position: absolute" text="#{resources.colection}"/>
                            <h:messages binding="#{nomenclaturalgroup$editNomenclaturalGroup.messageList1}" errorClass="errorMessage" fatalClass="fatalMessage"
                                id="messageList1" infoClass="infoMessage" style="left: 648px; top: 24px; position: absolute" warnClass="warnMessage"/>
                            <webuijsf:textArea binding="#{nomenclaturalgroup$editNomenclaturalGroup.txt_notes}" id="txt_notes" style="height: 48px; left: 144px; top: 216px; position: absolute; width: 408px"/>
                            <webuijsf:button actionExpression="#{nomenclaturalgroup$editNomenclaturalGroup.btn_save_action}"
                                ...
                                style="height: 24px; left: 623px; top: 120px; position: absolute; width: 47px" text="#{resources.btnSave}"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$editNomenclaturalGroup.label5}" id="label5"
                                style="left: 48px; top: 72px; position: absolute" text="#{resources.name}"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$editNomenclaturalGroup.label6}" id="label6"
                                style="left: 48px; top: 216px; position: absolute" text="#{resources.notes}"/>
                            <webuijsf:textArea binding="#{nomenclaturalgroup$editNomenclaturalGroup.txt_description}" id="txt_description" style="height: 48px; left: 144px; top: 120px; position: absolute; width: 408px"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$editNomenclaturalGroup.label7}" id="label7"
                                style="left: 48px; top: 192px; position: absolute" text="#{resources.certifier}"/>
                            <webuijsf:label binding="#{nomenclaturalgroup$editNomenclaturalGroup.label8}" id="label8"
                                style="left: 48px; top: 48px; position: absolute" text="#{resources.id}"/>
                            <webuijsf:staticText binding="#{nomenclaturalgroup$editNomenclaturalGroup.st_id}" id="st_id" style="left: 144px; top: 48px; position: absolute"/>
                            <webuijsf:tabSet binding="#{nomenclaturalgroup$editNomenclaturalGroup.tabSet1}" id="tabSet1" selected="tab_taxon1" style="border: 1px solid gray; height: 36px; left: 48px; top: 312px; position: absolute; width: 766px">
                                <webuijsf:tab binding="#{nomenclaturalgroup$editNomenclaturalGroup.tab_taxon1}" id="tab_taxon1" text="#{resources.taxon}">
                                    <webuijsf:panelLayout binding="#{nomenclaturalgroup$editNomenclaturalGroup.layoutPanel1}" id="layoutPanel1" style="height: 274px; position: relative; width: 100%; -rave-layout: grid">
                                ...
                                <webuijsf:tab binding="#{nomenclaturalgroup$editNomenclaturalGroup.tab_region1}" id="tab_region1" text="#{resources.regions}">
                                    <webuijsf:panelLayout binding="#{nomenclaturalgroup$editNomenclaturalGroup.layoutPanel2}" id="layoutPanel2" style="height: 272px; position: relative; width: 100%; -rave-layout: grid">
                                        <webuijsf:addRemove availableItemsLabel="#{resources.availables}:"
                            ...
                            <webuijsf:dropDown binding="#{nomenclaturalgroup$editNomenclaturalGroup.dd_commonName}" id="dd_commonName"
                                items="#{nomenclaturalgroup$editNomenclaturalGroup.dd_commonNameDefaultOptions.options}" label="#{resources.common_name}" style="left: 360px; top: 72px; position: absolute"/>
                        </webuijsf:form>
                    </webuijsf:panelLayout>
