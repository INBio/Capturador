                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form id="form1">
                                ...
                                <webuijsf:tab binding="#{site$editSite.tab1}" id="tab1" text="#{resources.coordinates}">
                                    <webuijsf:panelLayout binding="#{site$editSite.layoutPanel1}" id="layoutPanel1" style="height: 203px; position: relative; width: 100%; -rave-layout: grid">
                                        ...
                                        <webuijsf:button actionExpression="#{site$editSite.btn_addCoordinate_action}"
                                            ...
                                            style="height: 24px; left: 71px; top: 120px; position: absolute; width: 72px" text="#{resources.btnNew}"/>
                                        <webuijsf:table binding="#{site$editSite.table1}" id="table1"
                                            style="left: 383px; top: 72px; position: absolute; width: 364px" title="#{resources.actuals}" width="364">
                            ...
                            <webuijsf:label binding="#{site$editSite.label7}" id="label7" requiredIndicator="true"
                                style="left: 48px; top: 216px; position: absolute" text="#{resources.base_proyection}"/>
                            <webuijsf:textArea binding="#{site$editSite.txt_description}" id="txt_description" style="height: 48px; left: 168px; top: 120px; position: absolute; width: 648px"/>
                            <webuijsf:label binding="#{site$editSite.label8}" id="label8" requiredIndicator="true"
                                style="height: 24px; left: 48px; top: 120px; position: absolute; width: 24px" text="#{resources.description}"/>
                            <webuijsf:textField binding="#{site$editSite.txt_datum}" id="txt_datum" style="left: 168px; top: 312px; position: absolute" validatorExpression="#{util$ValidatorHelper.integerNumberFormatValidator}"/>
                            <webuijsf:dropDown binding="#{site$editSite.dd_originalProjection}" id="dd_originalProjection"
                                items="#{site$SiteSessionBean.originalProjection}" selected="#{site$SiteSessionBean.selectedOriginalProjection}" style="left: 168px; top: 288px; position: absolute"/>
                            <webuijsf:label binding="#{site$editSite.label9}" id="label9" requiredIndicator="true"
                                style="left: 48px; top: 288px; position: absolute" text="#{resources.orig_proyection}"/>
                            <webuijsf:dropDown binding="#{site$editSite.dd_baseProjection}" id="dd_baseProjection"
                                items="#{site$SiteSessionBean.projectionOption}" selected="#{site$SiteSessionBean.selectedProjection}" style="left: 168px; top: 216px; position: absolute"/>
                            <webuijsf:label binding="#{site$editSite.label10}" id="label10" style="left: 48px; top: 264px; position: absolute" text="#{resources.presition}"/>
                            <webuijsf:button actionExpression="#{site$editSite.btn_save_action}" binding="#{site$editSite.btn_save}" id="btn_save"
                                style="height: 24px; left: 479px; top: 192px; position: absolute; width: 71px" text="#{resources.btnSave}"/>
                            <webuijsf:label binding="#{site$editSite.label11}" id="label11" style="left: 48px; top: 72px; position: absolute" text="#{resources.id}"/>
                            <webuijsf:staticText binding="#{site$editSite.st_siteId}" id="st_siteId" style="left: 168px; top: 72px; position: absolute"/>
                        </webuijsf:form>
                    </webuijsf:panelLayout>
