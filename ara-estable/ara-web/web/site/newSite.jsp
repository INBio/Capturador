                ...
                <webuijsf:body binding="#{site$newSite.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{site$newSite.form1}" id="form1">
                            ...
                            <webuijsf:textArea binding="#{site$newSite.txt_description}" id="txt_description" style="height: 40px; left: 216px; top: 72px; position: absolute; width: 600px"/>
                            <webuijsf:label binding="#{site$newSite.label4}" id="label4" requiredIndicator="true"
                                style="left: 48px; top: 144px; position: absolute" text="#{resources.type}"/>
                            <webuijsf:dropDown binding="#{site$newSite.dd_featureType}" id="dd_featureType" items="#{site$SiteSessionBean.featureTypeOption}"
                                selected="#{site$SiteSessionBean.selectedFeatureType}" style="left: 216px; top: 144px; position: absolute"/>
                            <webuijsf:label binding="#{site$newSite.label5}" id="label5" requiredIndicator="true"
                                style="left: 48px; top: 168px; position: absolute" text="#{resources.base_proyection}"/>
                            <webuijsf:dropDown binding="#{site$newSite.dd_baseProjection}" id="dd_baseProjection"
                                items="#{site$SiteSessionBean.projectionOption}" selected="#{site$SiteSessionBean.selectedProjection}" style="left: 216px; top: 168px; position: absolute"/>
                            <webuijsf:label binding="#{site$newSite.label6}" id="label6" requiredIndicator="true"
                                style="left: 48px; top: 192px; position: absolute" text="#{resources.determination_method}"/>
                            <webuijsf:dropDown binding="#{site$newSite.dd_siteCalculationMethod}" id="dd_siteCalculationMethod"
                                items="#{site$SiteSessionBean.siteCalculationMethod}" selected="#{site$SiteSessionBean.selectedSiteCalculationMethod}" style="left: 216px; top: 192px; position: absolute"/>
                            <webuijsf:label binding="#{site$newSite.label7}" id="label7" style="left: 48px; top: 216px; position: absolute" text="#{resources.presition}"/>
                            <webuijsf:textField binding="#{site$newSite.txt_precision}" id="txt_precision" style="left: 216px; top: 216px; position: absolute" validatorExpression="#{util$ValidatorHelper.integerNumberFormatValidator}"/>
                            <webuijsf:label binding="#{site$newSite.label8}" id="label8" requiredIndicator="true"
                                style="left: 48px; top: 240px; position: absolute" text="#{resources.orig_proyection}"/>
                            ...
                            <webuijsf:tabSet binding="#{site$newSite.tabSet1}" id="tabSet1" selected="tab1" style="border: 1px solid gray; height: 35px; left: 48px; top: 312px; position: absolute; width: 766px">
                                <webuijsf:tab binding="#{site$newSite.tab1}" id="tab1" text="#{resources.coordinates}">
                                    <webuijsf:panelLayout binding="#{site$newSite.layoutPanel1}" id="layoutPanel1" style="border: 1px solid gray; height: 263px; position: relative; width: 100%; -rave-layout: grid">
                                        ...
                                        <webuijsf:textField binding="#{site$newSite.txt_longitude_degrees}" id="txt_longitude_degrees" style="left: 120px; top: 48px; position: absolute; width: 120px"/>
                                        <webuijsf:label binding="#{site$newSite.label11}" id="label11"
                                            style="font-size: 16px; font-style: normal; font-weight: bold; left: 24px; top: 144px; position: absolute" text="#{resources.latitude}"/>
                                        <webuijsf:textField binding="#{site$newSite.txt_latitude_degrees}" id="txt_latitude_degrees" style="left: 120px; top: 168px; position: absolute; width: 120px"/>
                                        <webuijsf:button actionExpression="#{site$newSite.btn_addCoordinate_action}" binding="#{site$newSite.btn_addCoordinate}"
                                            id="btn_addCoordinate" style="height: 24px; left: 335px; top: 24px; position: absolute; width: 72px" text="#{resources.btnNew}"/>
                                        <webuijsf:table binding="#{site$newSite.table1}" id="table1"
                                            style="left: 336px; top: 72px; position: absolute; width: 383px" title="#{resources.currents}" width="383">
                                        ...
                                        <webuijsf:textField binding="#{site$newSite.txt_longitude_minutes}" id="txt_longitude_minutes"
                                            style="position: absolute; left: 120px; top: 72px; width: 144px; height: 24px" text="0"/>
                                        <webuijsf:textField binding="#{site$newSite.txt_longitude_seconds}" id="txt_longitude_seconds"
                                            style="position: absolute; left: 120px; top: 96px; width: 144px; height: 24px" text="0"/>
                                        <webuijsf:textField binding="#{site$newSite.txt_latitude_minutes}" id="txt_latitude_minutes"
                                            style="position: absolute; left: 120px; top: 192px; width: 144px; height: 24px" text="0"/>
                                        <webuijsf:textField binding="#{site$newSite.txt_latitude_seconds}" id="txt_latitude_seconds"
                            ...
                            <webuijsf:button actionExpression="#{site$newSite.btn_save_action}" binding="#{site$newSite.btn_save}" id="btn_save"
                                style="height: 24px; left: 407px; top: 72px; position: absolute; width: 96px" text="#{resources.btnSave}"/>
                        </webuijsf:form>
                    </webuijsf:panelLayout>
