                        ...
                        <webuijsf:form binding="#{site$listSite.form1}" id="form1">
                            ...
                            <webuijsf:table binding="#{site$listSite.table1}" clearSortButton="true" id="table1" paginateButton="true" paginationControls="true"
                                ...
                                <webuijsf:tableRowGroup binding="#{site$listSite.tableRowGroup1}" id="tableRowGroup1" rows="10"
                                    ...
                                    <webuijsf:tableColumn align="center" binding="#{site$listSite.tableColumn7}" headerText="#{resources.actions}" id="tableColumn7">
                                ...
                                <f:facet name="actionsTop">
                                    <webuijsf:button actionExpression="#{site$listSite.btn_new_action}" binding="#{site$listSite.btn_new}" id="btn_new"
                                        style="height: 24px; width: 47px" text="#{resources.btnNew}"/>
                                </f:facet>
                            </webuijsf:table>
                        </webuijsf:form>
