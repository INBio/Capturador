                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{site$listSite.form1}" id="form1">
                            ...
                            <webuijsf:label binding="#{site$listSite.label1}" id="label1"
                                style="font-size: 24px; height: 22px; left: 48px; top: 24px; position: absolute; width: 238px" text="#{resources.sites}"/>
                            <webuijsf:table binding="#{site$listSite.table1}" clearSortButton="true" id="table1" paginateButton="true" paginationControls="true"
                                sortPanelToggleButton="true" style="left: 48px; top: 72px; position: absolute; width: 864px" title="#{resources.locations}" width="864">
                                <webuijsf:tableRowGroup binding="#{site$listSite.tableRowGroup1}" id="tableRowGroup1"
                                    rows="#{site$SiteSessionBean.pagination.resultsPerPage}" sourceData="#{site$SiteSessionBean.pagination.dataProvider}" sourceVar="currentRow">
                                    ...
                                    <webuijsf:tableColumn align="center" binding="#{site$listSite.tableColumn7}" headerText="#{resources.actions}"
                                        id="tableColumn7" style="width:110px">
                                ...
                                <f:facet name="actionsTop">
                                    <webuijsf:panelGroup id="groupPanel1">
                                        ...
                                        <webuijsf:panelGroup separator=" " style="margin-left:100px;">
                                            <webuijsf:button actionExpression="#{site$SiteSessionBean.pagination.firstResults}" id="btnFirst"
                                                text="#{resources.pagination_first}" visible="#{site$SiteSessionBean.pagination.isVisiblePrevious}"/>
                                            <webuijsf:button actionExpression="#{site$SiteSessionBean.pagination.previousResults}" id="btnNext"
                                                text="#{resources.pagination_previous}" visible="#{site$SiteSessionBean.pagination.isVisiblePrevious}"/>
                                            <webuijsf:button actionExpression="#{site$SiteSessionBean.pagination.nextResults}" id="btnPrevious"
                                                text="#{resources.pagination_next}" visible="#{site$SiteSessionBean.pagination.isVisibleNext}"/>
                                            <webuijsf:button actionExpression="#{site$SiteSessionBean.pagination.lastResults}" id="btnLast"
                                                text="#{resources.pagination_last}" visible="#{site$SiteSessionBean.pagination.isVisibleNext}"/>
                                        </webuijsf:panelGroup>
                                    </webuijsf:panelGroup>
                                </f:facet>
                            </webuijsf:table>
