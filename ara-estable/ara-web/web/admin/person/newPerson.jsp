                ...
                <webuijsf:body binding="#{admin$person$newPerson.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{admin$person$newPerson.form1}" id="form1">
                            <webuijsf:tabSet binding="#{admin$person$newPerson.personTabSet}" id="personTabSet" mini="true" selected="personalInfoTab" style="border: 1px solid gray; background-color: rgb(255, 255, 255); height: 334px; left: 48px; top: 72px; position: absolute; width: 778px">
                                <webuijsf:tab actionExpression="#{admin$person$newPerson.personalInfoTab_action}"
                                    ...
                                    <webuijsf:panelLayout binding="#{admin$person$newPerson.layoutPanel1}" id="layoutPanel1" style="height: 318px; position: relative; width: 767px; -rave-layout: grid">
                                        ...
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_firstName}" id="txt_firstName" label=" " maxLength="100"
                                            required="true" style="left: 161px; top: 48px; position: absolute"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_lastName}" id="txt_lastName" label=" " maxLength="100"
                                            required="true" style="left: 161px; top: 72px; position: absolute"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_secondLastName}" id="txt_secondLastName" maxLength="100" style="left: 168px; top: 96px; position: absolute"/>
                                        ...
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_initials}" id="txt_initials" style="left: 168px; top: 120px; position: absolute; width: 40px"/>
                                        ...
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_occupation}" id="txt_occupation" style="left: 168px; top: 216px; position: absolute"/>
                                ...
                                <webuijsf:tab actionExpression="#{admin$person$newPerson.personalInfoTab_action}" binding="#{admin$person$newPerson.tab1}"
                                    ...
                                    <webuijsf:panelLayout binding="#{admin$person$newPerson.layoutPanel2}" id="layoutPanel2" style="height: 292px; position: relative; width: 100%; -rave-layout: grid">
                                        <webuijsf:label binding="#{admin$person$newPerson.label7}" id="label7" style="left: 24px; top: 24px; position: absolute" text="#{resources.mail}"/>
                                        <webuijsf:label binding="#{admin$person$newPerson.label8}" id="label8" style="left: 24px; top: 48px; position: absolute" text="#{resources.web}"/>
                                        <webuijsf:label binding="#{admin$person$newPerson.label9}" id="label9" style="left: 24px; top: 72px; position: absolute" text="#{resources.phone_number}"/>
                                        <webuijsf:label binding="#{admin$person$newPerson.label10}" id="label10"
                                            style="left: 24px; top: 96px; position: absolute" text="#{resources.fax}"/>
                                        <webuijsf:label binding="#{admin$person$newPerson.label12}" id="label12"
                                            style="left: 24px; top: 120px; position: absolute" text="#{resources.address}"/>
                                        <webuijsf:label binding="#{admin$person$newPerson.label13}" id="label13"
                                            style="left: 24px; top: 192px; position: absolute" text="#{resources.city}"/>
                                        <webuijsf:label binding="#{admin$person$newPerson.label14}" id="label14"
                                            style="left: 24px; top: 216px; position: absolute" text="#{resources.state}"/>
                                        <webuijsf:label binding="#{admin$person$newPerson.label15}" id="label15"
                                            style="left: 24px; top: 264px; position: absolute" text="#{resources.country}"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_email}" id="txt_email"
                                            style="left: 168px; top: 24px; position: absolute" validatorExpression="#{util$ValidatorHelper.txt_email_validate}"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_url}" id="txt_url"
                                            style="left: 168px; top: 48px; position: absolute" validatorExpression="#{util$ValidatorHelper.url_validate}"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_telephone}" id="txt_telephone"
                                            style="left: 168px; top: 72px; position: absolute" validatorExpression="#{util$ValidatorHelper.telephone_validate}"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_fax}" id="txt_fax" style="left: 168px; top: 96px; position: absolute"/>
                                        <webuijsf:textArea binding="#{admin$person$newPerson.ta_streetAddress}" columns="19" id="ta_streetAddress" style="height: 45px; left: 168px; top: 120px; position: absolute; width: 220px"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_city}" id="txt_city" style="left: 168px; top: 192px; position: absolute"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_state}" id="txt_state" style="left: 168px; top: 216px; position: absolute"/>
                                        <webuijsf:textField binding="#{admin$person$newPerson.txt_country}" id="txt_country" style="left: 168px; top: 264px; position: absolute"/>
                                    </webuijsf:panelLayout>
                                </webuijsf:tab>
                            ...
                            <webuijsf:button actionExpression="#{admin$person$newPerson.btn_save_action}" binding="#{admin$person$newPerson.btn_save}"
                                id="btn_save" primary="true" style="height: 24px; left: 215px; top: 432px; position: absolute; width: 79px" text="#{resources.btnSave}"/>
                            <webuijsf:button actionExpression="#{admin$person$newPerson.btn_reset_action}" binding="#{admin$person$newPerson.btn_reset}"
                                id="btn_reset" reset="true" style="height: 24px; left: 311px; top: 432px; position: absolute; width: 79px" text="#{resources.btnClean}"/>
