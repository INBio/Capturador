                ...
                <webuijsf:body binding="#{admin$person$editPerson.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{admin$person$editPerson.form1}" id="form1">
                            ...
                            <webuijsf:tabSet binding="#{admin$person$editPerson.personTabSet1}" id="personTabSet1" mini="true" selected="personalInfoTab1" style="border: 1px solid gray; background-color: rgb(255, 255, 255); height: 334px; left: 48px; top: 72px; position: absolute; width: 790px">
                                <webuijsf:tab actionExpression="#{admin$person$editPerson.personalInfoTab_action}"
                                    ...
                                    <webuijsf:panelLayout binding="#{admin$person$editPerson.layoutPanel1}" id="layoutPanel1" style="height: 318px; position: relative; width: 791px; -rave-layout: grid">
                                        ...
                                        <webuijsf:label binding="#{admin$person$editPerson.label3}" id="label3"
                                            style="left: 24px; top: 72px; position: absolute" text="#{resources.last}"/>
                                        <webuijsf:label binding="#{admin$person$editPerson.label4}" id="label4"
                                            style="left: 24px; top: 96px; position: absolute" text="#{resources.second}"/>
                                ...
                                <webuijsf:tab actionExpression="#{admin$person$editPerson.personalInfoTab_action}" binding="#{admin$person$editPerson.tab1}"
                                    ...
                                    <webuijsf:panelLayout binding="#{admin$person$editPerson.layoutPanel2}" id="layoutPanel2" style="height: 292px; position: relative; width: 100%; -rave-layout: grid">
                                        ...
                                        <webuijsf:label binding="#{admin$person$editPerson.label12}" id="label12"
                                            style="left: 24px; top: 120px; position: absolute" text="#{resources.fax}"/>
                                        <webuijsf:label binding="#{admin$person$editPerson.label13}" id="label13"
                                            style="left: 24px; top: 144px; position: absolute" text="#{resources.address}"/>
                                        ...
                                        <webuijsf:label binding="#{admin$person$editPerson.label15}" id="label15"
                                            style="left: 24px; top: 240px; position: absolute" text="#{resources.state}"/>
                                        ...
                                        <webuijsf:textField binding="#{admin$person$editPerson.txt_email1}" id="txt_email1"
                                            style="left: 168px; top: 48px; position: absolute" validatorExpression="#{util$ValidatorHelper.txt_email_validate}"/>
                                        <webuijsf:textField binding="#{admin$person$editPerson.txt_url1}" id="txt_url1"
                                            style="left: 168px; top: 72px; position: absolute" validatorExpression="#{util$ValidatorHelper.url_validate}"/>
                                        <webuijsf:textField binding="#{admin$person$editPerson.txt_telephone1}" id="txt_telephone1"
                                            style="left: 168px; top: 96px; position: absolute" validatorExpression="#{util$ValidatorHelper.telephone_validate}"/>
                                        <webuijsf:textField binding="#{admin$person$editPerson.txt_fax1}" id="txt_fax1" style="left: 168px; top: 120px; position: absolute"/>
                                        <webuijsf:textArea binding="#{admin$person$editPerson.ta_streetAddress1}" columns="19" id="ta_streetAddress1" style="height: 45px; left: 168px; top: 144px; position: absolute; width: 220px"/>
                                        <webuijsf:textField binding="#{admin$person$editPerson.txt_city1}" id="txt_city1" style="left: 168px; top: 216px; position: absolute"/>
                                        <webuijsf:textField binding="#{admin$person$editPerson.txt_state1}" id="txt_state1" style="left: 168px; top: 240px; position: absolute"/>
                                        <webuijsf:textField binding="#{admin$person$editPerson.txt_country1}" id="txt_country1" style="left: 168px; top: 264px; position: absolute"/>
                                    </webuijsf:panelLayout>
                                </webuijsf:tab>
                            ...
                            <webuijsf:button actionExpression="#{admin$person$editPerson.btn_save_action}" binding="#{admin$person$editPerson.btn_save1}"
                                id="btn_save1" primary="true" style="height: 24px; left: 215px; top: 432px; position: absolute; width: 79px" text="#{resources.save}"/>
                            <webuijsf:button actionExpression="#{admin$person$editPerson.btn_reset_action}" binding="#{admin$person$editPerson.btn_reset1}"
                                id="btn_reset1" reset="true" style="height: 24px; left: 311px; top: 432px; position: absolute; width: 79px" text="#{resources.clean}"/>
