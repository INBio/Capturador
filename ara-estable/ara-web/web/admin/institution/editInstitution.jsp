                ...
                <webuijsf:body binding="#{admin$institution$editInstitution.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido">
                        <webuijsf:form binding="#{admin$institution$editInstitution.form1}" id="form1">
                            ...
                            <webuijsf:tabSet binding="#{admin$institution$editInstitution.institutionTabSet}" id="institutionTabSet" selected="basicInfoTab" style="border: 1px solid gray; height: 334px; left: 48px; top: 96px; position: absolute; width: 678px">
                                <webuijsf:tab actionExpression="#{admin$institution$editInstitution.basicInfoTab_action}"
                                    ...
                                    <webuijsf:panelLayout binding="#{admin$institution$editInstitution.layoutPanel1}" id="layoutPanel1" style="height: 334px; position: relative; width: 100%; -rave-layout: grid">
                                        ...
                                        <webuijsf:staticText binding="#{admin$institution$editInstitution.staticText5}" id="staticText5"
                                            style="font-family: 'Arial','Helvetica',sans-serif; font-weight: bold; left: 384px; top: 96px; position: absolute" text="#{resources.state}"/>
                                        <webuijsf:staticText binding="#{admin$institution$editInstitution.staticText6}" id="staticText6"
                                            style="font-family: 'Arial','Helvetica',sans-serif; font-weight: bold; left: 384px; top: 120px; position: absolute" text="#{resources.city}"/>
                                        ...
                                        <webuijsf:textField binding="#{admin$institution$editInstitution.txt_state}" id="txt_state" maxLength="100" style="left: 480px; top: 96px; position: absolute"/>
                                        <webuijsf:textField binding="#{admin$institution$editInstitution.txt_city}" id="txt_city" maxLength="100" style="left: 480px; top: 120px; position: absolute"/>
                                        ...
                                        <webuijsf:staticText id="label_code"
                                            style="font-family: 'Arial','Helvetica',sans-serif; font-weight: bold; height: 24px; left: 384px; top: 24px; position: absolute; width: 166px" text="#{resources.institutioncode}"/>
                                        <webuijsf:textField binding="#{admin$institution$editInstitution.txt_code}" columns="10" id="txt_code" required="true" style="height: 24px; left: 552px; top: 24px; position: absolute; width: 70px"/>
                                        <webuijsf:staticText binding="#{admin$institution$editInstitution.staticText8}" id="staticText8"
                                            style="font-family: 'Arial','Helvetica',sans-serif; font-weight: bold; left: 384px; top: 48px; position: absolute" text="#{resources.acronym}"/>
                                        <webuijsf:textField binding="#{admin$institution$editInstitution.txt_acronym}" id="txt_acronym" maxLength="10" style="left: 480px; top: 48px; position: absolute"/>
                                        <webuijsf:staticText binding="#{admin$institution$editInstitution.staticText9}" id="staticText9"
                                            style="font-family: 'Arial','Helvetica',sans-serif; font-weight: bold; left: 384px; top: 72px; position: absolute" text="#{resources.web_site}"/>
                                        <webuijsf:textField binding="#{admin$institution$editInstitution.txt_url}" id="txt_url" maxLength="500" style="left: 480px; top: 72px; position: absolute"/>
