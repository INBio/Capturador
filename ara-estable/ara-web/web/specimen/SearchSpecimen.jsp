                ...
                <webuijsf:body binding="#{specimen$SearchSpecimen.body1}" id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:panelLayout id="contenido" style="position: relative; -rave-layout: grid">
                        <webuijsf:form binding="#{specimen$SearchSpecimen.form1}" id="form1">
                            ...
                            <webuijsf:panelLayout binding="#{specimen$SearchSpecimen.layoutPanel1}" id="layoutPanel1" style="border: 2px groove black; height: 188px; left: 48px; top: 100px; position: absolute; width: 500px; -rave-layout: grid">
                                ...
                                <webuijsf:label binding="#{specimen$SearchSpecimen.collectionLabel}" id="collectionLabel"
                                    style="left: 24px; top: 72px; position: absolute" text="#{resources.collection}"/>
                                <webuijsf:textField binding="#{specimen$SearchSpecimen.collectionTF}" id="collectionTF" style="left: 240px; top: 72px; position: absolute; width: 215px"/>
                                <webuijsf:label binding="#{specimen$SearchSpecimen.collectorObserverLabel}" id="collectorObserverLabel"
                                    style="left: 24px; top: 96px; position: absolute" text="#{resources.collector_observer}"/>
                                <webuijsf:textField binding="#{specimen$SearchSpecimen.collectorObserverTF}" id="collectorObserverTF" style="left: 240px; top: 96px; position: absolute; width: 215px"/>
                                <webuijsf:button actionExpression="#{specimen$SearchSpecimen.searchButton_action}"
                                    ...
                                    style="height: 24px; left: 143px; top: 144px; position: absolute; width: 72px" text="#{resources.btnSearch}"/>
