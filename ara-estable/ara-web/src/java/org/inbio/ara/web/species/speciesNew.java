 ...
 * speciesNew.java
 *
 * Created on January 15, 2008, 5:37 PM
 * Copyright roaguilar
 */
 ...
 */
public class speciesNew extends AbstractPageBean {
    ...
    private PanelLayout ly_Header1 = new PanelLayout();
    
    public PanelLayout getLy_Header1() {
        return ly_Header1;
    }
    
    public void setLy_Header1(PanelLayout pl) {
        this.ly_Header1 = pl;
    }
    ...
    private DropDown dd_species = new DropDown();
    
    public DropDown getDd_species() {
        return dd_species;
    }
    
    public void setDd_species(DropDown dd) {
        this.dd_species = dd;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module speciesNew Initialization Failure", e);
    ...
    private void fillHeaderInfo() {
        ...
        this.setSpeciesOptions(this.getspecies$SpeciesSessionBean().getSpecies());
    }
    ...
    public String btn_save_action() {
        if (validate()) {
            ...
            this.getspecies$SpeciesSessionBean().setCurrentTaxon(this.getspecies$SpeciesSessionBean().getTaxon(this.getspecies$SpeciesSessionBean().getSelectedTaxonId()));
            
            TaxonDescription taxonDescription = new TaxonDescription();
            TaxonDescriptionPK pk = new TaxonDescriptionPK();
            
            pk.setTaxonId(getspecies$SpeciesSessionBean().getCurrentTaxon().getTaxonId());
            pk.setTaxonDescriptionSequence((Long)this.getTxt_SpeciesVersion().getValue());
            
            taxonDescription.setTaxonDescriptionPK(pk);
            ...
            taxonDescription.setCreatedBy(userName);
            ...
            if (this.getspecies$SpeciesSessionBean().create(taxonDescription)) {
                this.getspecies$SpeciesSessionBean().setCurrentTaxonDescriptionCategoryId(-1);
                return "saveNewSpeciesRecord";
            } else {
                return null;
            }
        } else {
    ...
    public Option[] getSpeciesOptions() {
        return speciesOptions;
    }
    
    public void setSpeciesOptions(Option[] speciesOptions) {
