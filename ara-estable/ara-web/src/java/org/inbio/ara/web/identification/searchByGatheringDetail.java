 ...
 */ 
/*
 * searchByGatheringDetail.java
 *
 * Created on July 16, 2008, 5:36 PM
 * Copyright roaguilar
 */
...
import org.inbio.ara.web.gathering.*;
 ...
 */
public class searchByGatheringDetail extends AbstractPageBean {
	
	public static final String CHOOSE_COLLECTOR = BundleHelper.getDefaultBundleValue("choose_collector");
	public static final String EMTPY_CATHERING_NUMBER = BundleHelper.getDefaultBundleValue("emtpy_cathering_number");
	public static final String NO_SPECIMEN_TO_ADD = BundleHelper.getDefaultBundleValue("no_specimen_to_add");
    ...
    private TextField txt_gatheringNumber1 = new TextField();

    public TextField getTxt_gatheringNumber1() {
        return txt_gatheringNumber1;
    }

    public void setTxt_gatheringNumber1(TextField tf) {
        this.txt_gatheringNumber1 = tf;
    }
    ...
    private DropDown dd_collector1 = new DropDown();

    public DropDown getDd_collector1() {
        return dd_collector1;
    }

    public void setDd_collector1(DropDown dd) {
        this.dd_collector1 = dd;
    }
    ...
    private Button btn_search1 = new Button();

    public Button getBtn_search1() {
        return btn_search1;
    }

    public void setBtn_search1(Button b) {
        this.btn_search1 = b;
    }

    private Button btn_load1 = new Button();

    public Button getBtn_load1() {
        return btn_load1;
    }

    public void setBtn_load1(Button b) {
        this.btn_load1 = b;
    }
    ...
    private TextField txt_specimenCount1 = new TextField();

    public TextField getTxt_specimenCount1() {
        return txt_specimenCount1;
    }

    public void setTxt_specimenCount1(TextField tf) {
        this.txt_specimenCount1 = tf;
    }
     ...
     */
    public searchByGatheringDetail() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module searchByGatheringDetail Initialization Failure", e);
    ...
    public void prerender() {
        this.txt_collectionName1.setText(this.getSessionManager().getCollection().getName());
        this.getidentification$IdentificationSearchSessionBean().populateGatheringDetailOptions();
    }
    ...
    public String btn_search_action() {
        if (validate()) {
            this.getidentification$IdentificationSearchSessionBean().searchByGatheringDetail(this.txt_gatheringNumber1.getValue().toString());
        }
        return null;
    }

    public String btn_load_action() {
        if (validate()) {
            if (this.getidentification$IdentificationSearchSessionBean().getSpecimenCount() > 0) {
                this.getidentification$IdentificationSearchSessionBean().getSpecimenArrayByGatheringDetail(this.txt_gatheringNumber1.getValue().toString());
                this.getidentification$IdentificationSearchSessionBean().cleanParameters();
                return "goBack";
            } else {
                this.getutil$MessageBean().addErrorMessage(NO_SPECIMEN_TO_ADD);
                return null;
            }
        } else {
            return null;
    ...
    private boolean validate() {
        if (this.getidentification$IdentificationSearchSessionBean().getSelectedCollector() == null) {
            this.getutil$MessageBean().addErrorMessage(CHOOSE_COLLECTOR);
            return false;
        }
        if (this.txt_gatheringNumber1.getValue()==null) {
            this.getutil$MessageBean().addErrorMessage(EMTPY_CATHERING_NUMBER);
            return false;
        }
        return true;
    }
