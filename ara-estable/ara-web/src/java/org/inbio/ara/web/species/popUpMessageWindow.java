 ...
 *
 * Created on February 22, 2008, 11:07 AM
 * Copyright roaguilar
 */
 ...
 */
public class popUpMessageWindow extends AbstractPageBean {
    ...
    private Button btn_closeWindow = new Button();

    public Button getBtn_closeWindow() {
        return btn_closeWindow;
    }

    public void setBtn_closeWindow(Button b) {
        this.btn_closeWindow = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module popUpMessageWindow Initialization Failure", e);
    ...
    public String btn_closeWindow_action() {
