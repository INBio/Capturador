 ...
 * EditAudience.java
 *
 * Created on November 19, 2007, 10:46 PM
 * Copyright roaguilar
 */
...
public class EditAudience extends AbstractPageBean {
	private static final String EMPTY_AUDIENCE_NAME = BundleHelper.getDefaultBundleValue("empty_audience_name");
    ...
    public void init() {
        ...
        try {
            ...
            log("Module editAudience initialization Failure", e);
    ...
    public void prerender() {
        ...
        Audience audience = getaudience$AudienceSessionBean().getAudience();
    ...
    public String btn_save_action() {
        if (this.validateFields()) {
            Audience audience = this.getaudience$AudienceSessionBean().getAudience();

            audience.setName((String)this.txt_name.getValue());
            audience.setDescription((String)this.txt_description.getValue());
            if (this.getaudience$AudienceSessionBean().update(audience)) {
                return "doSaveAudience";
            } else {
                return null;
            }
        } else {
    ...
    private boolean validateFields() {
        ...
        if (this.txt_name.getValue() == null) {
            this.getutil$MessageBean().addErrorMessage(EMPTY_AUDIENCE_NAME);
            ok = false;
        }
        return ok;
    }
