 ...
 * borrar.java
 *
 * Created on 12 de marzo de 2008, 04:47 PM
 * Copyright herson
 */
 ...
 */
public class borrar extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("borrar Initialization Failure", e);
    ...
    public void prerender() {
        ...
        this.getGridPanel1().setBorder(4);
        System.out.println("****************");
        Map h = this.getGridPanel1().getAttributes();
