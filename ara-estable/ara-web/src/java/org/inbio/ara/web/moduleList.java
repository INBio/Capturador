 ...
 * moduleList.java
 *
 * Created on May 14, 2008, 11:53 AM
 * Copyright roaguilar
 */
 ...
 */
public class moduleList extends AbstractPageBean {
    ...
    private Table t_module = new Table();

    public Table getT_module() {
        return t_module;
    }

    public void setT_module(Table t) {
        this.t_module = t;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("moduleList Initialization Failure", e);
    ...
    public String hlink_module_action() {
        RowKey rowKey = this.tableRowGroup1.getRowKey();
        return this.getSessionManager().getSelectedModuleNavigationRule(rowKey);
    }
