 ...
 */ 
/*
 * listNomenclaturalGroup.java
 *
 * Created on June 28, 2008, 1:52 PM
 * Copyright roaguilar
 */
...
public class listNomenclaturalGroup extends AbstractPageBean {
    ...
    private void _init() throws Exception {
		table1.setStyle("left: 0px; top: 192px; position: absolute; width: 100%");
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module listNomenclaturalGroup Initialization Failure", e);
    ...
    public void prerender() {
        this.getnomenclaturalgroup$NomenclaturalGroupSessionBean().getNomenclaturalGroupDataProvider().refreshList();
    }
    ...
    public String btn_edit_action() {
        /*
        this.getnomenclaturalgroup$NomenclaturalGroupSessionBean().setEditMode(false);
        this.getnomenclaturalgroup$NomenclaturalGroupSessionBean().setNomenclaturalGroup(this.tableRowGroup1.getRowKey());
        this.getnomenclaturalgroup$NomenclaturalGroupSessionBean().populateList();
        return "editNomenclaturalGroup";
         */
    ...
    public String btn_remove_action() {
        ...
        this.getnomenclaturalgroup$NomenclaturalGroupSessionBean().delete(rowKey);
        return null;
         */
