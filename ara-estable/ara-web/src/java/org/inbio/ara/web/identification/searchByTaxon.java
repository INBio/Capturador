 ...
 * searchByTaxon.java
 *
 * Created on July 15, 2008, 12:33 AM
 * Copyright roaguilar
 */
 ...
 */
public class searchByTaxon extends AbstractPageBean {
	
	public static final String NO_SPECIMENS_TO_ADD = BundleHelper.getDefaultBundleValue("no_specimens_to_add");
    ...
    private Listbox lst_taxon = new Listbox();

    public Listbox getLst_taxon() {
        return lst_taxon;
    }

    public void setLst_taxon(Listbox l) {
        this.lst_taxon = l;
    }
    ...
    private Button btn_load = new Button();

    public Button getBtn_load() {
        return btn_load;
    }

    public void setBtn_load(Button b) {
        this.btn_load = b;
    }

    private TextField txt_specimenCount = new TextField();

    public TextField getTxt_specimenCount() {
        return txt_specimenCount;
    }

    public void setTxt_specimenCount(TextField tf) {
        this.txt_specimenCount = tf;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module searchByTaxon Initialization Failure", e);
    ...
    public void prerender() {
        this.getidentification$IdentificationSearchSessionBean().populateTaxonOptions();
    }
    ...
    public String btn_search_action() {
        this.getidentification$IdentificationSearchSessionBean().searchByTaxon();
        return null;
    }

    public String btn_load_action() {
        if (this.getidentification$IdentificationSearchSessionBean().getSpecimenCount() > 0) {
            this.getidentification$IdentificationSearchSessionBean().getSpecimenArrayByTaxon();
            this.getidentification$IdentificationSearchSessionBean().cleanParameters();
            return "goBack";
        } else {
            this.getutil$MessageBean().addErrorMessage(NO_SPECIMENS_TO_ADD);
            return null;
        }
    }
