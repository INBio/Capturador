 ...
 * speciesNew_v2.java
 *
 * Created on April 1, 2008, 2:28 PM
 * Copyright roaguilar
 */
 ...
 */
public class speciesNew_v2 extends AbstractPageBean {
    ...
    private TextField txt_SpeciesVersion1 = new TextField();

    public TextField getTxt_SpeciesVersion1() {
        return txt_SpeciesVersion1;
    }

    public void setTxt_SpeciesVersion1(TextField tf) {
        this.txt_SpeciesVersion1 = tf;
    }

    private TextField txt_Title1 = new TextField();

    public TextField getTxt_Title1() {
        return txt_Title1;
    }

    public void setTxt_Title1(TextField tf) {
        this.txt_Title1 = tf;
    }

    private DropDown dp_Language1 = new DropDown();

    public DropDown getDp_Language1() {
        return dp_Language1;
    }

    public void setDp_Language1(DropDown dd) {
        this.dp_Language1 = dd;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module  speciesNew_v2 Initialization Failure", e);
