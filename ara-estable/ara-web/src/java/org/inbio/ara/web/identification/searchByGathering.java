 ...
 */ 
/*
 * searchByGathering.java
 *
 * Created on July 16, 2008, 1:41 PM
 * Copyright roaguilar
 */
 ...
 */
public class searchByGathering extends AbstractPageBean {
	
	public static final String INVALID_GATHERING_ID = BundleHelper.getDefaultBundleValue("invalid_gathering_id");
	public static final String INVALID_GATHERING_ID_NUMERIC = BundleHelper.getDefaultBundleValue("invalid_gathering_id_numeric");
	public static final String INVALID_GATHERING_ID_ZERO = BundleHelper.getDefaultBundleValue("invalid_gathering_id_zero");
    ...
    private TextField txt_gatheringId = new TextField();

    public TextField getTxt_gatheringId() {
        return txt_gatheringId;
    }

    public void setTxt_gatheringId(TextField tf) {
        this.txt_gatheringId = tf;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("searchByGathering Initialization Failure", e);
    ...
    public String btn_load_action() {
        if (this.getGatheringObservationId()!= null) {
            if (this.getidentification$IdentificationSearchSessionBean().getSpecimenCount() > 0) {
                this.getidentification$IdentificationSearchSessionBean().getSpecimenArrayByGatheringObservation(this.getGatheringObservationId());
    ...
    public String btn_search_action() {
        if (getGatheringObservationId()!= null) {
            this.getidentification$IdentificationSearchSessionBean().searchByGatheringId(getGatheringObservationId());
        }
        return null;
    }
    
    private Long getGatheringObservationId() {
        if (this.txt_gatheringId.getValue() != null) {
            try {
                String tmp = this.txt_gatheringId.getValue().toString();
                Long gatheringId = Long.parseLong(tmp);
                if (gatheringId <= 0L) {
                    this.getutil$MessageBean().addErrorMessage(INVALID_GATHERING_ID_ZERO);
                    return null;
                }
                return gatheringId;
            } catch (NumberFormatException ex) {
                this.getutil$MessageBean().addErrorMessage(INVALID_GATHERING_ID_NUMERIC);
                return null;
            }
        } else {
            this.getutil$MessageBean().addErrorMessage(INVALID_GATHERING_ID);
            return null;
        }
    }
