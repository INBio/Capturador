 ...
 * dynamicTable.java
 *
 * Created on January 31, 2008, 9:19 PM
 * Copyright roaguilar
 */
 ...
 */
public class dynamicTable extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("Module dynamicTable Initialization Failure", e);
    ...
    private Table createTable() {
        ...
        rowGroup.setValueBinding("sourceData", getApplication().createValueBinding("#{admin$person$PersonSessionBean.personDataProvider}"));
        rowGroup.setRows(5);
        ...
        staticText1.setValueBinding("text", getApplication().createValueBinding("#{currentRow.value['id']}"));
        ...
        staticText2.setValueBinding("text", getApplication().createValueBinding("#{currentRow.value['firstName']}"));
        ...
        staticText3.setValueBinding("text", getApplication().createValueBinding("#{currentRow.value['lastName']}"));
        ...
        button1.setAction(getApplication().createMethodBinding("#{NIUS$dynamicTable.button1_action}", null));
        
        // Add the Static Text3 to the table column3
        tableColumn4.getChildren().add(button1);
        
        // Now add the table to the form
