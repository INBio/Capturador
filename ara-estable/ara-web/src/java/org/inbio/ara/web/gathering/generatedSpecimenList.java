 ...
 */ 
/*
 * generatedSpecimenList.java
 *
 * Created on August 1, 2008, 12:13 PM
 * Copyright roaguilar
 */
 ...
 */
public class generatedSpecimenList extends AbstractPageBean {
    ...
    private StaticText st_collectionName = new StaticText();

    public StaticText getSt_collectionName() {
        return st_collectionName;
    }

    public void setSt_collectionName(StaticText st) {
        this.st_collectionName = st;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module generatedSpecimenList initialization Failure", e);
    ...
    public void prerender() {
        this.st_collectionName.setValue(this.getSessionManager().getCollection().getName());
        String desc;
