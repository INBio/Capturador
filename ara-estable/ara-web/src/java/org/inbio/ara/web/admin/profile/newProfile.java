 ...
 * newProfile.java
 *
 * Created on November 12, 2007, 1:08 AM
 * Copyright roaguilar
 */
 ...
 */
public class newProfile extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("Module newProfile initialization Failure", e);
    ...
    public String btn_save_action() {
        if (validateFields()) {
            ...
            profile.setName((String)this.getTxt_name().getValue());
            profile.setDescription((String)this.getTxt_description().getValue());
            profile.setCreatedBy(getSessionManager().getUser().getUserName());
            profile.setLastModificationBy(getSessionManager().getUser().getUserName());

            if (this.getadmin$profile$ProfileSessionBean().create(profile)) {
                return "doSaveNewProfile";
            } else {
