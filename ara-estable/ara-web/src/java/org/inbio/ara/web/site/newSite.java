 ...
 * newSite.java
 *
 * Created on June 26, 2008, 1:38 PM
 * Copyright roaguilar
 */
...
public class newSite extends AbstractPageBean {
	...
	public static final String NOT_APPLY = BundleHelper.getDefaultBundleValue("not_apply");
    ...
    private Button btn_removeCoord = new Button();

    public Button getBtn_removeCoord() {
        return btn_removeCoord;
    }

    public void setBtn_removeCoord(Button b) {
        this.btn_removeCoord = b;
    }
    ...
    public void lst_coordinate_processValueChange(ValueChangeEvent event) {
