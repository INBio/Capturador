 ...
 * newPerson.java
 *
 * Created on September 30, 2007, 2:37 PM
 * Copyright roaguilar
 */
...
public class newPerson extends AbstractPageBean {
	...
	private static final String CREATION_SUCCESS = BundleHelper.getDefaultBundleValue("creation_success");
    private static final String CREATION_FAILURE = BundleHelper.getDefaultBundleValue("create_record_failed");
	private static final String FIRSTNAME_REQUIRED = BundleHelper.getDefaultBundleValue("firstname_required");
	...
	private TabSet personTabSet = new TabSet();

	public TabSet getPersonTabSet() {
		return personTabSet;
	}

	public void setPersonTabSet(TabSet ts) {
		this.personTabSet = ts;
	}
	private Tab personalInfoTab = new Tab();

	public Tab getPersonalInfoTab() {
		return personalInfoTab;
	}

	public void setPersonalInfoTab(Tab t) {
		this.personalInfoTab = t;
	}
	...
	private TextField txt_firstName = new TextField();

	public TextField getTxt_firstName() {
		return txt_firstName;
	}

	public void setTxt_firstName(TextField tf) {
		this.txt_firstName = tf;
	}
	private TextField txt_lastName = new TextField();

	public TextField getTxt_lastName() {
		return txt_lastName;
	}

	public void setTxt_lastName(TextField tf) {
		this.txt_lastName = tf;
	}
	private TextField txt_secondLastName = new TextField();

	public TextField getTxt_secondLastName() {
		return txt_secondLastName;
	}

	public void setTxt_secondLastName(TextField tf) {
		this.txt_secondLastName = tf;
	}
	...
	private TextField txt_initials = new TextField();

	public TextField getTxt_initials() {
		return txt_initials;
	}

	public void setTxt_initials(TextField tf) {
		this.txt_initials = tf;
	}
	...
	private TextField txt_birthYear = new TextField();

	public TextField getTxt_birthYear() {
		return txt_birthYear;
	}

	public void setTxt_birthYear(TextField tf) {
		this.txt_birthYear = tf;
	}
	...
	private TextField txt_deathYear = new TextField();

	public TextField getTxt_deathYear() {
		return txt_deathYear;
	}

	public void setTxt_deathYear(TextField tf) {
		this.txt_deathYear = tf;
	}
	...
	private TextField txt_occupation = new TextField();

	public TextField getTxt_occupation() {
		return txt_occupation;
	}

	public void setTxt_occupation(TextField tf) {
		this.txt_occupation = tf;
	}
	...
	private TextField txt_email = new TextField();

	public TextField getTxt_email() {
		return txt_email;
	}

	public void setTxt_email(TextField tf) {
		this.txt_email = tf;
	}
	...
	private TextArea ta_streetAddress = new TextArea();

	public TextArea getTa_streetAddress() {
		return ta_streetAddress;
	}

	public void setTa_streetAddress(TextArea ta) {
		this.ta_streetAddress = ta;
	}
	...
	private AddRemove addRemove_profile = new AddRemove();

	public AddRemove getAddRemove_profile() {
		return addRemove_profile;
	}

	public void setAddRemove_profile(AddRemove ar) {
		this.addRemove_profile = ar;
	}
	private AddRemove addRemove_institution = new AddRemove();

	public AddRemove getAddRemove_institution() {
		return addRemove_institution;
	}

	public void setAddRemove_institution(AddRemove ar) {
		this.addRemove_institution = ar;
	}
	...
	public void setBtn_reset(Button b) {
		this.btn_reset = b;
	}
	...
	public void prerender() {
		this.txt_lastName.setRequiredMessage(FIRSTNAME_REQUIRED);
	...
	public String btn_save_action() {
		...
		person.setFirstName((String) txt_firstName.getText());
		person.setLastname((String) txt_lastName.getText());
		person.setSecondLastName((String) txt_secondLastName.getText());
		person.setInitials((String) txt_initials.getText());

        try {
            person.setBirthYear(Integer.parseInt(txt_birthYear.getText().toString()));
            person.setDeathYear(Integer.parseInt(txt_deathYear.getText().toString()));
        } catch (NumberFormatException numberFormatException) {
        } catch (NullPointerException nullPointerException) {
        }
  
		person.setOccupation((String) txt_occupation.getText());
		person.setTelephone((String) txt_telephone.getText());
		person.setFax((String) txt_fax.getText());
		person.setStreetAddress((String) ta_streetAddress.getText());
		person.setCity((String) txt_city.getText());
		person.setStateName((String) txt_state.getText());
        ...
        try {
            if (this.getadmin$person$PersonSessionBean().create(person)) {
                this.getutil$MessageBean().addSuccessMessage(CREATION_SUCCESS);
            ...
            this.getutil$MessageBean().addSuccessMessage(CREATION_FAILURE);
            return null;
        }
	}
	 ...
	 * <p>Return a reference to the scoped data bean.</p>
	 */
	protected org.inbio.ara.web.admin.profile.ProfileSessionBean getadmin$profile$ProfileSessionBean() {
		return (org.inbio.ara.web.admin.profile.ProfileSessionBean) getBean("admin$profile$ProfileSessionBean");
	}
...
//Todo esto se movio a Validator Helper
    /*
