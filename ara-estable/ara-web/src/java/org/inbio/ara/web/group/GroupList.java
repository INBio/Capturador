 ...
 */
public class GroupList extends AbstractPageBean {
	...
	private void _init() throws Exception {
		groupTable1.setStyle("left: 0px; top: 192px; position: absolute; width: 100%");
	}
	...
	private Table groupTable1 = new Table();

	public Table getGroupTable1() {
		return groupTable1;
	}

	public void setGroupTable1(Table t) {
		this.groupTable1 = t;
	}
	...
	private Button btn_disable1 = new Button();

	public Button getBtn_disable1() {
		return btn_disable1;
	}

	public void setBtn_disable1(Button b) {
		this.btn_disable1 = b;
	}
	...
	public void init() {
		...
		try {
			...
			log("Module groupList Initialization Failure", e);
	...
	public String btn_Edit1_action() {
		if (this.getSessionManager().canModify() != null) {
			this.getgroup$GroupSessionBean().setSelectedOptions(new Long[]{});
			RowKey rowKey = this.tableRowGroup1.getRowKey();
			this.getgroup$GroupSessionBean().setSelectedGroup(rowKey);
	...
	public String btn_disable1_action() {
		if (this.getSessionManager().canDelete() != null) {
			RowKey rowKey = this.tableRowGroup1.getRowKey();
			this.getgroup$GroupSessionBean().setSelectedGroup(rowKey);
			if (getgroup$GroupSessionBean().delete()) {
			} else {
			}
		} else {
