 ...
 */
public class AudienceList extends AbstractPageBean {
    ...
    private void _init() throws Exception {
		audienceTable.setStyle("left: 0px; top: 216px; position: absolute; width: 100%");
    }
    ...
    private Table audienceTable = new Table();

    public Table getAudienceTable() {
        return audienceTable;
    }

    public void setAudienceTable(Table t) {
        this.audienceTable = t;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module audienceList initialization Failure", e);
    ...
    public String btn_edit_action() {
        if (this.getSessionManager().canModify()!=null) {
            ...
            getaudience$AudienceSessionBean().setSelectedAudience(rowKey);
    ...
    public String btn_remove_action() {
        if (this.getSessionManager().canDelete()!= null) {
            RowKey rowKey = this.tableRowGroup1.getRowKey();
            getaudience$AudienceSessionBean().setSelectedAudience(rowKey);
            if (getaudience$AudienceSessionBean().delete()) {
            } else {
            }
        } else {
