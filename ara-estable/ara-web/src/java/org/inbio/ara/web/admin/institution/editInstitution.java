 ...
 */ 
/*
 * editInstitution.java
 *
 * Created on November 11, 2007, 11:33 PM
 * Copyright roaguilar
 */
...
public class editInstitution extends AbstractPageBean {
	...
	private static final String EMPTY_ENTITY = BundleHelper.getDefaultBundleValue("empty_entity");
    ...
    public void prerender() {
        this.txt_address.setMaxLength(500);
        //Person tperson = getadmin$person$PersonSessionBean().getPerson();
        Institution tInstitution = getadmin$institution$InstitutionSessionBean().getInstitution();
        if (tInstitution == null) {
            this.txt_name.setText(EMPTY_ENTITY);
        } else {
            this.txt_acronym.setText(tInstitution.getAcronym());
            this.txt_address.setText(tInstitution.getStreetAddress());
            this.txt_city.setText(tInstitution.getCity());
            this.txt_country.setText(tInstitution.getCountry());
            this.txt_fax.setText(tInstitution.getFax());
            this.txt_name.setText(tInstitution.getName());
    ...
    public String btn_save_action() {
        Institution institution = this.getadmin$institution$InstitutionSessionBean().getInstitution();
    ...
    public String btn_cancel_action() {
        ...
        return "doCancelEditInstitution";
    }
