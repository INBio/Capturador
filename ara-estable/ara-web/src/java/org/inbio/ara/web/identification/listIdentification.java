 ...
 */ 
/*
 * listIdentification.java
 *
 * Created on June 24, 2008, 8:10 PM
 * Copyright roaguilar
 */
...
public class listIdentification extends AbstractPageBean {
    ...
    private void _init() throws Exception {
		table1.setStyle("left: 0px; top: 216px; position: absolute; width: 100%");
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Module listIdentification Initialization Failure", e);
    ...
    public String btn_remove_action() {
        ...
        this.getidentification$IdentificationSessionBean().delete(rowKey);
        return null;
         */
