 ...
 */
public class NewAudience extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("Module newAudience initialization Failure", e);
    ...
    public String btn_save_action() {
        if (validateFields()) {
            ...
            audience.setName((String)this.getTxt_name().getValue());
            audience.setDescription((String)this.getTxt_description().getValue());
            audience.setCreatedBy("roaguilar");
            audience.setLastModificationBy("roaguilar");

            if (this.getaudience$AudienceSessionBean().create(audience)) {
                return "doSaveNewAudience";
            } else {
                return null;
            }            
        } else {
